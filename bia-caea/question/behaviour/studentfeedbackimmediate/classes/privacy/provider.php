...
namespace qbehaviour_studentfeedbackimmediate\privacy;
...
class provider extends \qbehaviour_studentfeedbackdeferred\privacy\provider
    ...
    /**
     * @var string $behaviourname The name for this question behaviour. Used for inheritance.
     */
    public static $behaviourname = 'studentfeedbackimmediate';
