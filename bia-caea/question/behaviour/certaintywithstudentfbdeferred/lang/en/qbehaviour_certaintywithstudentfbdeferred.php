...
$string['confidencerate'] = 'Confidence';
...
$string['declaredignorancerate'] = 'Random answers rate';
$string['declaredignorancerate_help'] = '<p>Indicates the percentage of questions where you answered giving the minimal certainty level "{$a}", which is interpreted as a "random" answer. Answers associated with this certainty level are not taken into account in other metacognitive indicators.</p><div><b>Value:</b> between 0% and 100%</div>';
$string['declaredignoranceratea'] = 'Random answers rate: {$a}';
$string['declaredignorancerateabove'] = 'Random answers rate above {$a}';
$string['declaredignoranceratebelow'] = 'Random answers rate below {$a}';
...
$string['lucidityindex_help'] = '<p>Index computed as an aggregate of certainty levels on answers (excluding random answers), depending on classification of said answers (proven successes and presumed errors count positively, unexpected errors and lucky successes count negatively).<br>The higher this value is, the higher it means that you were rather sure of your correct answers and unsure of your incorrect answers. To the contrary, if this value is rather low (openly under 0), this indicates a problem as you seem more sure about your incorrect answers than your correct ones! If it is around 0, it means that you are as sure about your correct answers than your incorrect answers.</p><div><b>Value:</b> between -100 and 100</div>';
$string['lucidityindex_nodi'] = 'Lucidity index';
$string['lucidityindex_nodi_help'] = '<p>Index computed as an aggregate of certainty levels on answers, depending on classification of said answers (proven successes and presumed errors count positively, unexpected errors and lucky successes count negatively).<br>The higher this value is, the higher it means that you were rather sure of your correct answers and unsure of your incorrect answers. To the contrary, if this value is rather low (openly under 0), this indicates a problem as you seem more sure about your incorrect answers than your correct ones! If it is around 0, it means that you are as sure about your correct answers than your incorrect answers.</p><div><b>Value:</b> between -100 and 100</div>';
$string['lucidityindexa'] = 'Lucidity index: {$a}';
$string['lucidityindexdisclaimer'] = 'There are few questions on this quiz, lucidity index may be biased.';
$string['lucidityindicatorallegederror'] = 'No unexpected error, but at least one presumed error';
$string['lucidityindicatordeclaredignorance'] = 'All questions are answered at random';
$string['lucidityindicatorsureknowledge'] = 'All answers are proven success';
$string['lucidityindicatorunexpectederror'] = 'At least one unexpected error';
$string['lucidityindicatorunsureknowledge'] = 'No error, but at least one lucky success';
...
$string['nnocertainty'] = 'Answers with no certainty provided: {$a}';
$string['nnotanswered'] = 'Questions not answered: {$a}';
$string['noallegederror'] = 'No presumed error';
$string['nocertaintyprovided'] = 'You did not select a certainty level!';
$string['nodeclaredignorance'] = 'No random answer';
$string['nosureknowledge'] = 'No proven success';
$string['nounexpectederror'] = 'No unexpected error';
$string['nounsureknowledge'] = 'No lucky success';
...
$string['settings:error:categoryorder'] = 'Please keep a continuity in certainty levels categorization: first optional level of Random answers, then levels of Lucky successes / Presumed errors, and finally levels of Proven successes / Unexpected errors.';
...
$string['sureknowledge'] = 'Proven success';
$string['sureknowledge_details'] = 'Proven success ({$a})';
$string['sureknowledgeplural'] = 'Proven successes';
...
$string['unsureknowledge'] = 'Lucky success';
$string['unsureknowledge_details'] = 'Lucky success ({$a})';
$string['unsureknowledgeplural'] = 'Lucky successes';
