...
$string['lucidityindex_help'] = '<p>Index computed as the inverse of the mean gap between your certainty level and the correctness of the associated answer (excluding random answers). The higher this value is, the higher it means that you were rather sure of your correct answers and unsure of your incorrect answers. To the contrary, if this value is rather low (openly under 50), this indicates a problem as you seem more sure about your incorrect answers than your correct ones! If it is around 50, it means that you are as sure about your correct answers than your incorrect answers.</p><div><b>Value:</b> between 0 and 100</div>';
$string['lucidityindex_nodi'] = 'Lucidity index';
$string['lucidityindex_nodi_help'] = '<p>Index computed as the inverse of the mean gap between your certainty level and the correctness of the associated answer. The higher this value is, the higher it means that you were rather sure of your correct answers and unsure of your incorrect answers. To the contrary, if this value is rather low (openly under 50), this indicates a problem as you seem more sure about your incorrect answers than your correct ones! If it is around 50, it means that you are as sure about your correct answers than your incorrect answers.</p><div><b>Value:</b> between 0 and 100</div>';
