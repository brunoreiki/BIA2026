...
/**
 * selfwithcapability enrolment plugin - support for user selfwithcapability unenrolment.
 *
...
$instance = $DB->get_record('enrol', [ 'id' => $enrolid, 'enrol' => 'selfwithcapability' ], '*', MUST_EXIST);
...
$PAGE->set_url('/enrol/selfwithcapability/unenrolself.php', [ 'enrolid' => $instance->id ]);
