...
if ($hassiteconfig && empty($ADMIN->locate(qbehaviour_certaintywithstudentfbdeferred\locallib::SETTINGSPAGE))) {
    $ADMIN->add('qbehavioursettings', new admin_externalpage(
            qbehaviour_certaintywithstudentfbdeferred\locallib::SETTINGSPAGE,
            get_string('pluginsettings', qbehaviour_certaintywithstudentfbdeferred\locallib::COMPONENT),
