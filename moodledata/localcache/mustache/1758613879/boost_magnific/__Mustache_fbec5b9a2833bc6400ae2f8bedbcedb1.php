...
class __Mustache_fbec5b9a2833bc6400ae2f8bedbcedb1 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionF5784ab6ba3c4dcf146d7b9f3635309f($context, $indent, $value);
...
';
        ...
        $buffer .= $this->section61dca19ee2b18e549a0ce3885f94f14d($context, $indent, $value);
...
';
    ...
    private function sectionF5784ab6ba3c4dcf146d7b9f3635309f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    {{< theme_boost_magnific/drawer }}
        ...
        {{$drawerheadercontent}}
        {{> theme_boost_magnific/courseindexdrawercontrols}}
        {{/drawerheadercontent}}
            ...
            foreach ($values as $value) {
                ...
                if ($parent = $this->mustache->loadPartial('theme_boost_magnific/drawer')) {
                    $context->pushBlockContext(array(
                        ...
                        'drawerheadercontent' => array($this, 'block1941f20473743d9328d65703ebad0f2a'),
...
';
    ...
    private function section61dca19ee2b18e549a0ce3885f94f14d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    public function block1941f20473743d9328d65703ebad0f2a($context)
    {
        $indent = $buffer = '';
        if ($partial = $this->mustache->loadPartial('theme_boost_magnific/courseindexdrawercontrols')) {
            $buffer .= $partial->renderInternal($context, $indent . '        ');
        }
