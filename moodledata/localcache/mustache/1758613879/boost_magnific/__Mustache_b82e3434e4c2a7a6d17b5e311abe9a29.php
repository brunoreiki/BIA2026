...
class __Mustache_b82e3434e4c2a7a6d17b5e311abe9a29 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionE4123f61c8d882410b0a31aca7548367($context, $indent, $value);
        $buffer .= '">
';
...
';
        ...
        $buffer .= $this->section5b64d1ef47ba74c42e4fe43c2bcc88cf($context, $indent, $value);

        return $buffer;
    }

    private function sectionE4123f61c8d882410b0a31aca7548367(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = 'courseindexoptions, theme_boost_magnific';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= 'courseindexoptions, theme_boost_magnific';
                $context->pop();
            }
        }
    ...
    private function section5b64d1ef47ba74c42e4fe43c2bcc88cf(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
