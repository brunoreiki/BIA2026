...
class __Mustache_54cca66cb80bc897aca8f29f7fcc1044 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionDdee66525db39cfa4dea79760cc4769c($context, $indent, $value);
        ...
        $buffer .= $this->section16b6885ab6e402dc9410ff9fcadcd186($context, $indent, $value);
        $value = $context->find('hasidentityproviders');
        $buffer .= $this->section2bbedb76c478aefa1a0201db3adf4ae8($context, $indent, $value);
...
';
        ...
        $buffer .= $this->sectionDc023de42ec174a39fa16998bdd41d8f($context, $indent, $value);
...
';
    ...
    private function sectionDdee66525db39cfa4dea79760cc4769c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section16b6885ab6e402dc9410ff9fcadcd186(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
            ...
            <div class="login-form-password mb-3">
                ...
                <div class="password-wrapper">
                    ...
                    <button type="button"
                            ...
                            title="{{#str}} passwordunmaskrevealhint, form {{/str}}"
                            aria-pressed="false">
...
';
                $buffer .= $indent . '                       class="form-control form-control-lg"
';
                $buffer .= $indent . '                       value="';
...
';
                ...
                $buffer .= '</label>
';
                $buffer .= $indent . '                <div class="password-wrapper">
';
...
';
                $buffer .= $indent . '                            id="togglePassword"
';
                $buffer .= $indent . '                            class="toggle-password"
';
                $buffer .= $indent . '                            title="';
                $value = $context->find('str');
                ...
                $buffer .= '"
';
                $buffer .= $indent . '                            aria-pressed="false">
';
...
';
                $buffer .= $indent . '                        const toggle = document.getElementById("togglePassword");
';
                $buffer .= $indent . '                        toggle.addEventListener("click", function () {
';
                $buffer .= $indent . '                            const input = document.getElementById("password");
';
...
';
    ...
    private function section2bbedb76c478aefa1a0201db3adf4ae8(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionDc023de42ec174a39fa16998bdd41d8f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
