...
class __Mustache_3670fb11bd19264199389a26888057df extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionDefd8cc86410053e5e721aebd0b5b8fb($context, $indent, $value);
        $buffer .= '"
';
...
';
        $buffer .= $indent . '    >
';
        $blockFunction = $context->findInBlock('format_tiles/local/content/section/content');
        if (is_callable($blockFunction)) {
            $buffer .= call_user_func($blockFunction, $context);
        } else {
            if ($partial = $this->mustache->loadPartial('format_tiles/local/content/section/content')) {
...
';
    ...
    private function sectionDefd8cc86410053e5e721aebd0b5b8fb(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
