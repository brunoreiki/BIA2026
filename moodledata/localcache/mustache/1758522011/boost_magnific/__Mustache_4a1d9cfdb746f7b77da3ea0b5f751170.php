...
class __Mustache_4a1d9cfdb746f7b77da3ea0b5f751170 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $indent . '<div id="course-section-header-';
        $value = $this->resolveValue($context->find('id'), $context);
        $buffer .= ($value === null ? '' : $value);
        $buffer .= '"
';
        $buffer .= $indent . '     class="course-section-header d-flex"
';
...
';
        ...
        $buffer .= $this->section595715aeef5c2712c3a567f7c3591cc3($context, $indent, $value);
        $value = $context->find('controlmenu');
        $buffer .= $this->sectionA05a9efa8a6615cafc2b7d6f99aac760($context, $indent, $value);
        $value = $context->find('header');
        $buffer .= $this->section3a8cac9d5887819ada6b2df5411263fc($context, $indent, $value);
        $buffer .= $indent . '</div>
';
...
';
        ...
        $buffer .= $this->section6d23ff05000d54b33bd6c98bc7c50d63($context, $indent, $value);
...
';
    ...
    private function section595715aeef5c2712c3a567f7c3591cc3(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            $source = '
        {{^displayonesection}}
            <div id="contract-everything-{{{id}}}" class="flex-fill d-flex justify-content-end align-self-start">
    ...
    ';
            ...
            foreach ($values as $value) {
                ...
                if (empty($value)) {
                    ...
                    $buffer .= $indent . '            <div id="contract-everything-';
                    $value = $this->resolveValue($context->find('id'), $context);
                    $buffer .= ($value === null ? '' : $value);
                    $buffer .= '" class="flex-fill d-flex justify-content-end align-self-start">
';
...
';
    ...
    private function sectionDe626570aed3bed66d2fc86ca3daa67f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function sectionA9650607bba38b174bd7710efb8754b9(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                ...
                $value = $context->find('str');
                $buffer .= $this->sectionDe626570aed3bed66d2fc86ca3daa67f($context, $indent, $value);
                $context->pop();
            }
        }
    ...
    private function sectionEa4b7b6368b31790b958fa866a323696(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                        $buffer .= $indent . '                                ';
                        $value = $context->find('pix');
                        $buffer .= $this->sectionA9650607bba38b174bd7710efb8754b9($context, $indent, $value);
                        $buffer .= '
';
                        $buffer .= $indent . '                            </span>
';
...
';
    ...
    private function section3a8cac9d5887819ada6b2df5411263fc(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->sectionEa4b7b6368b31790b958fa866a323696($context, $indent, $value);
                $context->pop();
            }
        }
...
';
    ...
    private function section6d23ff05000d54b33bd6c98bc7c50d63(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    require(["jquery"], function($) {
        $("#contract-everything-{{{id}}}").insertBefore("#course-section-header-{{{id}}} h3.sectionname");
    });
';
            $result = (string) call_user_func($value, $source, $this->lambdaHelper);
            $buffer .= $result;
...
';
                $buffer .= $indent . '        $("#contract-everything-';
                $value = $this->resolveValue($context->find('id'), $context);
                $buffer .= ($value === null ? '' : $value);
                $buffer .= '").insertBefore("#course-section-header-';
                $value = $this->resolveValue($context->find('id'), $context);
                $buffer .= ($value === null ? '' : $value);
                $buffer .= ' h3.sectionname");
';
                $buffer .= $indent . '    });
';
                $context->pop();
