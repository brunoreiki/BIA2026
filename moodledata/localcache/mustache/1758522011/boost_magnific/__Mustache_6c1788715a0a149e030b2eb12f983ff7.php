...
class __Mustache_6c1788715a0a149e030b2eb12f983ff7 extends Mustache_Template
{
...
';
        $buffer .= $indent . '        data-region="fixed-drawer"
';
        $buffer .= $indent . '        id="';
...
';
        ...
        $buffer .= '"
';
        $buffer .= $indent . '        data-close-on-resize="';
...
';
        $buffer .= $indent . '        <button class="btn drawertoggle icon-no-margin hidden"
';
...
';
        $buffer .= $indent . '            ';
        $blockFunction = $context->findInBlock('drawershowprogress');
        if (is_callable($blockFunction)) {
            $buffer .= call_user_func($blockFunction, $context);
        }
        $buffer .= '
...
';
        ...
        $buffer .= $this->section0ca8e224e285e165290180f48b765887($context, $indent, $value);
    ...
    private function section0ca8e224e285e165290180f48b765887(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
