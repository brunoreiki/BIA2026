...
class __Mustache_ef4129c5cb7db8e2e090c5d1dcbfca52 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section63e88948695a561f0bc9422eb98b5e83($context, $indent, $value);
...
';
    ...
    private function section63e88948695a561f0bc9422eb98b5e83(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '    require(["jquery", "core/modal", "core/notification"], function ($, Modal, Notification) {
';
