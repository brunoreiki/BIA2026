...
/**
 * Strings for component 'attendance', language 'fr', version '5.0'.
 *
 * @package     attendance
 * @category    string
...
$string['randomizepasscodesonrestore'] = 'Randomiser les codes d\'accès lors de la restauration';
$string['randomizepasscodesonrestore_desc'] = 'Lors de la restauration/copie d’un cours, remplacer les codes d\'accès existants par de nouveaux codes aléatoires.';
