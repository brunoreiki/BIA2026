...
/**
 * Strings for component 'block_glossary_export_to_quiz', language 'fr', version '5.0'.
 *
...
$string['addidnumber'] = 'Ajouter un Numéro d’identification';
$string['addidnumber_help'] = 'Ajouter un Numéro d’identification créé à partir du nom du Glossaire vers la catégorie exportée et utiliser le numéro de chaque question pour ajouter leur propre Numéro d’identification';
...
$string['exporttoquessit'] = 'Exporter les articles du glossaire vers des questions de type Devinette (option Wordle)';
...
$string['nbmaxletterswordle'] = 'Nombre de lettres pour l\'option Wordle';
$string['nbmaxletterswordle_help'] = 'Sélectionner la longueur maximale des concepts à sélectionner pour l\'exportation vers Wordle. Le minimum est de 4';
...
$string['notenoughentriesavailableforwordle'] = 'Il n\'y a pas assez d\'entrées disponibles pour fixer le nombre maximum de lettres dans les mots à {$a}.';
...
$string['selectquestiontype_help'] = 'Vous pouvez utiliser les types de questions par défaut de Moodle : Réponse courte, Choix multiple, Correspondance et Glisser-déposer dans le texte. S\'ils sont installés sur votre site, vous pouvez également utiliser Texte à trous et Devinette (Wordle - Devinez un mot).';
...
$string['validnumber'] = 'Saisir un nombre valide';
