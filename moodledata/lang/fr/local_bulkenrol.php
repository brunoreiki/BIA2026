...
/**
 * Strings for component 'local_bulkenrol', language 'fr', version '5.0'.
 *
...
$string['error_no_valid_email_in_list'] = 'Aucune adresse de courriel valide n’a été trouvée dans la liste donnée.<br />Veuillez <a href=\'{$a->url}\'>retourner et vérifier vos entrées</a>.';
