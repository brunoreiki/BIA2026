...
/**
 * Strings for component 'grades', language 'fr', version '5.0'.
 *
 * @package     grades
 * @category    string
...
$string['errornegativepenalty'] = 'Valeur négative reçue lors de l’application de la pénalité pour la note d’ID {$a}.';
...
$string['gradepenalty_enabledmodules'] = 'Activités activées';
$string['gradepenalty_enabledmodules_help'] = 'Activer les pénalités de note pour les activités sélectionnées.';
$string['gradepenalty_indicator_info'] = 'Pénalité de retard de –{$a} points appliquée';
$string['gradepenalty_supportedplugins'] = 'Gérer les activités prises en charge';
...
$string['managepenaltyplugins'] = 'Gérer les plugins de pénalité';
...
$string['modgraderecalculatepenalty'] = 'Recalculer la pénalité';
$string['modgraderecalculatepenalty_help'] = 'La pénalité sera recalculée pour tous les utilisateurs.';
...
$string['originalgrade'] = 'Note originale';
...
$string['recalculatepenalty'] = 'Recalculer les pénalités';
$string['recalculatepenaltyconfirm'] = 'Ceci recalculera et appliquera les pénalités pour tous les travaux remis dans ce contexte. Voulez-vous vraiment continuer ?';
$string['recalculatepenaltysuccess'] = 'Re-calcul des pénalités en cours. Il peut y avoir un délai avant que les notes soient mises à jour.';
$string['recalculatinggrades'] = 'Re-calcul des notes';
$string['recalculatinggradesadhoc'] = 'Ce rapport se mettra à jour automatiquement. Vous n’avez besoin de rien faire.';
