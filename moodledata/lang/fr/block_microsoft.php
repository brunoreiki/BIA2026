...
/**
 * Strings for component 'block_microsoft', language 'fr', version '5.0'.
 *
...
$string['linkcourserequest'] = 'Demander un cours issu de Teams';
$string['linkemail'] = 'Mes courriels';
$string['linkmsstream'] = 'Flux Microsoft';
$string['linkmsstreamclassic'] = 'Microsoft Stream (classique)';
...
$string['settings_courserequest'] = 'Demander un cours issu de Teams';
$string['settings_courserequest_desc'] = 'Demandez un nouveau cours issu de Microsoft Teams. Après approbation, le cours sera créé et connecté à une équipe. Les membres de l’équipe Microsoft seront inscrits au cours.';
...
$string['settings_showmsstreamclassic'] = 'Afficher « Microsoft Stream (classique) »';
$string['settings_showmsstreamclassic_desc'] = 'Activer ou désactiver le lien « Microsoft Stream (classique) » dans le bloc.';
