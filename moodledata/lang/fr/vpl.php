...
/**
 * Strings for component 'vpl', language 'fr', version '5.0'.
 *
 * @package     vpl
 * @category    string
...
$string['confirmoverridedeletion'] = 'Voulez-vous vraiment supprimer cette dérogation ?';
...
$string['diff'] = 'diff';
$string['directory_not_renamed'] = 'Le répertoire \'{$a}\' n’a pas été renommé';
...
$string['override'] = 'Déroger';
$string['override_help'] = 'Si la case « Déroger » est cochée, ce paramètre sera surchargé par la valeur indiquée pour les utilisateurs concernés.';
$string['override_options'] = 'Options de dérogation';
$string['override_users'] = 'Utilisateurs concernés';
$string['override_users_help'] = 'Un utilisateur ou groupe peut être affecté uniquement à un ensemble de dérogations.<br>
Si un utilisateur est affecté à un ensemble de dérogations, et qu’un groupe dont il est membre est affecté à un autre ensemble, alors l’affectation de l’utilisateur seul prévaut.<br>
Si un utilisateur est membre de plusieurs groupes affectés à plusieurs ensembles de dérogations, alors le premier dans la table prévaut.';
$string['overrides'] = 'Dérogations';
$string['overrides_help'] = 'Un ensemble de paramètres peut être dérogé pour une activité. Ces paramètres surchargeront les valeurs des paramètres de l’activité pour les utilisateurs et groupes concernés.';
$string['paste'] = 'Coller';
$string['pause'] = 'Pause';
...
$string['rename_directory'] = 'Renommer le répertoire';
...
$string['shrightpanel'] = 'Cacher / montrer le panneau de droite';
