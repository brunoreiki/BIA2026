...
/**
 * Strings for component 'tiny_h5p', language 'fr', version '5.0'.
 *
 * @package     tiny_h5p
 * @category    string
...
$string['h5p:use'] = 'Utiliser H5P TinyMCE';
...
$string['mobileappautoplay'] = 'Lire automatiquement dans l’app mobile';
