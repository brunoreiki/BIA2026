...
/**
 * Strings for component 'offlinequiz', language 'fr', version '5.0'.
 *
 * @package     offlinequiz
 * @category    string
...
$string['couldnotextractpages'] = 'Erreur lors de l\'extraction des pages des fichiers déposés.';
$string['couldnotextractpdf'] = 'Erreur lors de la conversion de pdf en images uniques. Veuillez essayer un document plus petit ou contactez votre administrateur.';
$string['couldnotextracttiff'] = 'Erreur lors de la conversion de tiff en images simples. Veuillez essayer un document plus petit ou contactez votre administrateur local.';
$string['couldnotgrab'] = 'Saisie de l’image {$a} impossible';
$string['couldnotinsertjobs'] = 'Erreur avec la base de données lors de l\'extraction des pages';
...
$string['createlistfirst'] = 'Ajouter d\'abord les listes de participants';
...
$string['furtheroptionsheading'] = 'Autres options';
...
$string['messageprovider:jobs'] = 'Notifications QCM papier';
...
$string['modulename_help'] = 'Ce module permet à l\'enseignant de concevoir des QCMs Papier constitués de questions à choix multiples. Ces questions sont conservées dans la banque de questions de Moodle et peuvent être réutilisées dans les cours et même entre les cours. Les quiz hors ligne peuvent être téléchargés sous forme de fichiers PDF, DOCX ou LaTeX. Les étudiants notent leurs réponses sur des formulaires. Les formulaires sont scannés et les réponses sont importées dans le système.

<p><a href="https://academic-moodle-cooperation.org/anleitungen/offline-test-einstellungen/?lng=en" target="_blank">Questionnaire en ligne : paramètres</a></p>
<p><a href="https://academic-moodle-cooperation.org/anleitungen/offline-test-fragen-hinzufugen-und-formulare-generieren/?lng=en" target="_blank">Questionnaire en ligne : ajouter des questions et générer des formulaires</a></p>
<p><a href="https://academic-moodle-cooperation.org/anleitungen/offline-test-durchfuhren-und-auswerten/?lng=en" target="_blank">Questionnaire en ligne : Conduire et évaluer un quiz hors ligne</a></p> <p>Les étudiants marquent leurs réponses sur des feuilles de formulaire.';
$string['modulenameplural'] = 'QCMs papier';
...
$string['offlinequizcloses'] = 'Clôture du QCM papier';
...
$string['privacy:metadata:offlinequizpagesize'] = 'Définit le nombre d\'entrées pour la page de résultats.';
...
$string['queueamountofpages'] = 'Nombre de fichiers inclus :';
$string['queuedownload'] = 'Télécharger';
$string['queuefilecorrect'] = 'Correct';
$string['queuefilecorrectionhovertext'] = 'Correction';
$string['queuefiledownloadhovertext'] = 'Télécharger';
$string['queuefileerror'] = 'Message d\'erreur :';
$string['queuefilefilename'] = 'Fichier d\'origine :';
$string['queuefilegroupnumber'] = 'Numéro de groupe :';
$string['queuefileheader'] = 'Pages de ce fichier';
$string['queuefileimportedat'] = 'Fichier importé :';
$string['queuefileimportedby'] = 'Importé par :';
$string['queuefilenotstarted'] = 'L\'évaluation n\'a pas encore commencé';
$string['queuefilepagenumber'] = 'Numéro de page :';
$string['queuefileprocessing'] = 'Évaluation en cours…';
$string['queuefilesactionsheader'] = 'Actions';
$string['queuefilesdetailsheader'] = 'Détails';
$string['queuefilesfileheader'] = 'Fichier';
$string['queuefilestatus'] = 'Statut du fichier :';
$string['queuefilestatusheader'] = 'Statut';
$string['queuefilestatusmessage_error'] = 'Correction nécessaire';
$string['queuefilestatusmessage_new'] = 'envoyé';
$string['queuefilestatusmessage_processed'] = 'OK';
$string['queuefilestatusmessage_processing'] = 'traitement';
$string['queuefilestatusmessage_submitted'] = 'envoyé';
$string['queuefilestudent'] = 'Nom de l\'étudiant :';
$string['queuefinishedtime'] = 'L\'évaluation s\'est achevée à';
$string['queueheader'] = 'Fichiers déposés';
$string['queuenotfinished'] = 'L\'évaluation n\'est pas terminée.';
$string['queuenotstarted'] = 'L\'évaluation n\'a pas commencé.';
$string['queuestarttime'] = 'L\'évaluation a débuté à :';
$string['queuestatus'] = 'Statut de la file d\'attente :';
...
$string['selectquestion'] = 'Sélectionner la question {$a}';
...
$string['tutorial:feedback:3:1'] = 'Seules les croix dans les cases sont scannées. C’est pourquoi il est si important de cocher les bonnes cases sous votre numéro d’identification.';
$string['tutorial:feedback:3:2'] = 'Seules les croix dans les cases sont scannées. C’est pourquoi il est si important de cocher les bonnes cases sous votre numéro d’identification.';
$string['tutorial:feedback:3:3'] = 'Seules les croix dans les cases sont scannées. C’est pourquoi il est si important de cocher les bonnes cases sous votre numéro d’identification.';
$string['tutorial:feedback:3:4'] = 'Seules les croix dans les cases sont scannées. C’est pourquoi il est si important de cocher les bonnes cases sous votre numéro d’identification.';
$string['tutorial:feedback:4:0'] = 'Vous avez commis une erreur. Votre numéro d’identification est {$a->correctusernumber}, mais vous avez marqué {$a->selectedusernumber}';
...
$string['tutorial:generatedusernumberwarning'] = 'Il s’agit d’un numéro d’identification généré puisque votre compte n’en a pas !';
...
$string['tutorial:header:4'] = '4. Marquage de votre numéro d’identification';
$string['tutorial:header:5'] = '5. Enfin…';
$string['tutorial:identification_info'] = 'Votre numéro d\'identification est : {$a}';
...
$string['tutorial:introduction:3:1'] = 'Le formulaire de réponse contient un bloc pour votre nom (A), un bloc pour votre numéro d’identification (B) et un bloc pour les réponses (C). Remplissez d’abord les cases contenant votre nom, votre signature et votre numéro d’identification. Notez que la machine n’essaiera pas d’interpréter votre écriture après l’examen. Ces cases sont uniquement à des fins de documentation.';
$string['tutorial:introduction:3:2'] = 'Cochez soigneusement les cases correspondant à votre numéro d’identification, car l’ordinateur aura besoin de ces marques pour identifier vos résultats. Des erreurs dans le bloc avec votre numéro d’identification peuvent entraîner des retards et des interprétations erronées.';
$string['tutorial:introduction:4'] = 'A la fin de ce tutoriel nous vous proposons un petit test où vous pourrez apprendre à remplir correctement les notes de votre numéro d’identification. Sous la case correspondant à votre numéro d’identification se trouve une matrice de cases. Chaque colonne représente un chiffre de votre numéro d’identification. Les lignes marquent les chiffres écrits à gauche et à droite. Cliquez sur les cases pour les marquer. Cliquez à nouveau pour supprimer votre marque. Si vous souhaitez recommencer, veuillez <a href="javascript: document.location.reload()">recharger la page</a>.';
...
$string['tutorial:option:3:3'] = 'Seules les croix dans les cases sous votre numéro d’identification sont interprétées.';
$string['tutorial:option:3:4'] = 'Le système lit votre numéro d’identification à l’aide d’un logiciel de reconnaissance optique de caractères.';
...
$string['tutorial:question:4'] = 'Numéro d’identification';
...
$string['tutorial:start_text'] = 'Ce tutoriel est censé vous montrer la manière correcte de remplir les formulaires d\'un quiz hors ligne et de marquer vos réponses pour l\'évaluation automatique. Nous vous recommandons vivement de suivre ce tutoriel au moins une fois, avant de passer votre premier test ou examen avec un questionnaire hors ligne.';
$string['tutorial:starttutorial'] = 'Démarrer le tutoriel';
...
$string['unknownmimetype'] = 'Mimetype inconnu ou non supporté {$a->mimetpye}';
...
$string['upgradingilogs'] = 'Réinitialiser les données du QCM Papier';
...
$string['uploadfurtherfiles'] = 'Déposer d\'autres fichiers';
...
$string['usetabs'] = 'Utiliser la navigation par onglets';
$string['usetabsdesc'] = 'Si cette option est activée, la navigation de troisième niveau du QCM papier sera affichée à l\'aide d\'onglets. Si elle est désactivée, la navigation dans le questionnaire hors ligne sera affichée à l\'aide d\'un menu déroulant.';
$string['valuezero'] = 'La valeur ne doit pas être nulle';
$string['viewresults'] = 'Voir les résultats';
$string['white'] = 'Blanc';
$string['wirismathenabled'] = 'Activer les équations mathématiques de WIRIS';
$string['wirismathenabled_help'] = 'Si cette option est activée, les équations mathématiques de WIRIS peuvent être utilisées dans le texte de la question et dans les réponses.';
