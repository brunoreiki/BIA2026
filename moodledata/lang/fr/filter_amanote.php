...
/**
 * Strings for component 'filter_amanote', language 'fr', version '5.0'.
 *
...
$string['privacy:metadata:email'] = 'L’adresse de courriel de l’utilisateur est envoyée au système distant pour permettre une meilleure expérience utilisateur (partage de notes, etc.).';
