...
/**
 * Strings for component 'board', language 'fr', version '5.0'.
 *
 * @package     board
 * @category    string
...
$string['invalid_youtube_url'] = 'Lien URL YouTube non valide';
...
$string['modal_title_new'] = 'Nouveau message pour la colonne {column}';
...
$string['sortbyrating'] = 'Évaluation';
