...
/**
 * Strings for component 'zoom', language 'fr', version '5.0'.
 *
 * @package     zoom
 * @category    string
...
$string['calendarjoinurl'] = 'URL de l\'activité de réunion : {$a}.';
...
$string['displayid'] = '(identifiant utilisateur) seulement';
$string['displayidfullname'] = '(identifiant utilisateur) suivi du com complet';
...
$string['grading_notfound'] = 'Liste des utilisateurs qui ont cliqué pour rejoindre la réunion, mais qui n’ont pas été reconnus dans le rapport des participants :\\n';
$string['gradingentry'] = 'Dès l’entrée';
$string['gradinglink'] = 'Réviser ou mettre à jour les notes';
$string['gradingmessagebody'] = 'Pour la session Zoom Meeting : {$a->zoomurl} ;
<br>
Nombre d’utilisateurs qui ont été automatiquement notés en fonction de leur durée dans la réunion : {$a->graded}.
<br>
Nombre d’utilisateurs déjà notés : {$a->alreadygraded}.
<br>
{$a->besoin de niveau</br>
...
$string['gradingmethod_heading'] = 'Options pour la méthode de notation';
$string['gradingmethod_heading_help'] = 'Décidez quelle méthode utiliser lors de l’évaluation de la participation à Zoom.';
$string['gradingmethod_help'] = 'Choisir la méthode à utiliser pour noter la participation des étudiants.<br>
À l\'entrée : l\'étudiant reçoit une note complète (note maximale) lorsqu\'il clique pour rejoindre la réunion dans Moodle.<br>
Durée de présence : l\'étudiant reçoit une note basée sur le pourcentage de sa présence à la réunion par rapport à la durée totale de la réunion.<br>
Notes concernant la méthode de la durée de présence :<br>
- Cette méthode nécessite que le nom d\'affichage contienne l\'identifiant ou le nom complet.
- Il est recommandé de définir le paramètre « zoom | defaultjoinbeforehost » sur (Non) afin que la durée de la réunion soit exacte.
- Certains étudiants qui sont déjà connectés au client Zoom et dont les détails ne correspondent pas à ceux de Moodle doivent être notés manuellement après avoir examiné le rapport de la réunion.';
$string['gradingperiod'] = 'Durée de la présence';
$string['gradingsmallmeassage'] = 'L\'utilisateur note le rapport rapide pour {$a->name} :
<br>
Besoin d\'une notation manuelle : {$a->number}
<br>
Utilisateurs notés : {$a->gradés + $a->alreadygraded}';
$string['host'] = 'Hôte';
...
$string['instanceusers_desc'] = 'Si l\'option Redéfinir les licences est activée, ne vérifier que les utilisateurs ayant une licence sur cette instance Moodle. Utile pour les configurations où des instances séparées se partagent un pool unique de licences Zoom.';
$string['invalid_status'] = 'Statut non valide, vérifiez la base de données.';
...
$string['messageprovider:ical_notifications'] = 'Envoyer aux participants des invitations iCal pour un événement Zoom nouvellement créé.';
$string['messageprovider:teacher_notification'] = 'Informer les enseignants des notes des utilisateurs (en fonction de la durée) lors d’une session Zoom';
...
$string['protectedgroups'] = 'Protéger les groupes';
$string['protectedgroups_desc'] = 'Sélectionner des groupes Zoom pour protéger les utilisateurs membres de la redéfinition des licences.';
...
$string['recordingtype_active_speaker'] = 'Haut-parleur actif';
...
$string['recordingtype_chat'] = 'Fichier Chat';
...
$string['recordingtype_shared_gallery'] = 'Écran partagé avec vue galerie';
$string['recordingtype_shared_speaker'] = 'Écran partagé avec vue sur l\'intervenant';
$string['recordingtype_shared_speaker_cc'] = 'Écran partagé avec vue sur l\'intervenant (sous-titres)';
$string['recordingtype_sign'] = 'Interprétation des signes';
$string['recordingtype_speaker'] = 'Vue de l\'orateur';
...
$string['sendicalnotifications_help'] = 'L\'activation de cette option permet d\'envoyer des notifications iCal via la tâche programmée « Envoyer une notification iCal ».';
$string['sendicalnotifications_warning'] = 'Les pièces jointes doivent être activées dans Administration du site / Serveur / Courriel / Configuration du courrier sortant pour utiliser cette option.';
$string['sessions'] = 'Sessions';
$string['sessionsreport'] = 'Rapport des sessions';
$string['sesskeyinvalid'] = 'Session non valide détectée. Impossible de continuer.';
...
$string['unamedisplay_help'] = 'Comment le nom d\'un utilisateur doit être affiché dans les réunions (ne fonctionne que pour les utilisateurs qui ne sont pas connectés au client Zoom).';
...
$string['webinar_help'] = 'Les webinaires offrent aux hôtes un contrôle et une flexibilité accrus pour organiser des réunions avec un public plus large. \\n\\nCette option est uniquement disponible pour les comptes Zoom pré-autorisés.';
...
$string['zoomerr_scopes'] = 'La configuration de Zoom OAuth ne contient pas les champs d\'application requis : {$a}';
