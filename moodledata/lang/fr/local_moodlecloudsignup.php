...
/**
 * Strings for component 'local_moodlecloudsignup', language 'fr', version '5.0'.
 *
...
$string['signup:messages.failedvalidationcode'] = 'Quelque chose ne vas pas avec ce code. L’avez-vous bien tapé correctement ?';
...
$string['telephony:lookup.invalidnumber'] = 'Numéro de téléphone non valide';
$string['telephony:lookup.notacellphone'] = 'Vous devez indiquer un numéro de téléphone valide';
$string['validators:fos_user.current_password.invalid'] = 'Le mot de passe saisi est non valide';
