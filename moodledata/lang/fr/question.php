...
/**
 * Strings for component 'question', language 'fr', version '5.0'.
 *
 * @package     question
 * @category    string
...
$string['banksincourse'] = 'Banques de questions dans ce cours';
...
$string['courserestore'] = 'Restauration de cours';
$string['created'] = 'Date de création';
$string['createdby'] = 'Créée par';
$string['createdefault'] = 'Créer une banque de questions par défaut';
...
$string['defaultbank'] = 'Banque de question du cours {$a->coursename}';
$string['defaultcreated'] = 'Banque de questions par défaut créée.';
...
$string['disabledbanks'] = 'Tous les types de module de banque de questions sont désactivés.';
...
$string['editcategories_help'] = 'Plutôt que de conserver toutes vos questions dans une longue liste, il est possible de les ranger dans des catégories et sous-catégories.
...
$string['invalidquestiontype'] = 'Type de question non valide : {$a}';
...
$string['nobanks'] = 'Ce cours n’a pas encore de banque de questions.';
...
$string['otherbanks'] = 'Autres activités avec des questions';
$string['otherbanksdesc'] = 'Les questions dans les banques de questions de ces activités ne peuvent pas être utilisées ailleurs.';
$string['otherquestionbank'] = 'Toutes les banques de questions';
$string['otherquestionbankstoomany'] = 'Plus de {$a} résultats ; veuillez affiner votre recherche.';
...
$string['previewbank'] = 'Prévisualisation de la banque de questions partagée';
...
$string['questionbank_plural'] = 'Banques de questions';
...
$string['quizquestionbank'] = 'Banque de questions de ce test';
$string['recentlyviewedquestionbanks'] = 'Banques de questions consultées récemment';
...
$string['switchbank'] = 'Changer de banque';
$string['systembank'] = 'Banque de questions partagées au niveau du système';
$string['systembankdescription'] = 'Cette banque de questions est créée automatiquement lors de la mise à jour du site.';
...
$string['versioninfolatestshort'] = 'v{$a} (dernière)';
