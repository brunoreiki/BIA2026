...
/**
 * Strings for component 'hub', language 'fr', version '5.0'.
 *
 * @package     hub
 * @category    string
...
$string['experttipsandinsights'] = 'Conseils et analyses d’experts';
$string['experttipsandinsightsdesc'] = 'Oui, je souhaite m’inscrire pour recevoir des conseils, des stratégies et des informations exclusives de la part d’experts Moodle et de Partenaires Certifiés. Vous pouvez modifier vos choix et vous désinscrire quand vous voulez, selon notre <a href="{$a}" target="_blank">Politique de protection des données</a>.';
