...
/**
 * Strings for component 'role', language 'fr', version '5.0'.
 *
 * @package     role
 * @category    string
...
$string['ai:viewaipolicyacceptancereport'] = 'Consulter le rapport d’acceptation de politique IA';
$string['ai:viewaiusagereport'] = 'Consulter le rapport d’utilisation d’IA';
...
$string['contentbank:changelockedcustomfields'] = 'Modifier les champs de la banque de contenu personnalisés verrouillés';
...
$string['course:changelockedcustomfields'] = 'Modifier les champs personnalisés ce cours verrouillés';
...
$string['course:viewoverview'] = 'Consulter la vue d’ensemble des activités';
...
$string['reportbuilder:configurecustomfields'] = 'Configurer les champs de rapport personnalisé';
