...
/**
 * Strings for component 'assign', language 'fr', version '5.0'.
 *
 * @package     assign
 * @category    string
...
$string['assignmentduedigestsms'] = 'Un ou plusieurs devoirs doivent être rendus dans les 7 jours. Connectez-vous pour voir les devoirs à rendre.';
...
$string['assignmentduesoonsms'] = 'Votre devoir {$a->assignmentname} est à rendre le {$a->duedate} : {$a->url}';
...
$string['assignmentmailhtml'] = '<p>{$a->grader} a donné un feedback pour le travail remis pour « {$a->assignment} ».</p>
...
$string['assignmentoverduesms'] = 'Votre devoir {$a->assignmentname} pour le {$a->duedate} est en retard : {$a->url}';
...
$string['gradepenalty'] = 'Pénalités de note';
...
$string['overriderecalculatepenalty'] = 'Recalculer la pénalité pour les utilisateurs dans la dérogation';
...
$string['penaltyduedatechangemessage'] = 'Des notes ont déjà été attribuées. Pour modifier la date d’échéance, activer/désactiver les pénalités, vous devez d’abord décider de recalculer ou non les notes existantes.';
...
$string['submissioncontains'] = 'Votre travail remis contient :';
...
$string['submissionreceiptcontains'] = 'Travail remis ({$a->total} éléments) :';
$string['submissionreceipthtml'] = '<p>Vous avez remis un travail pour le devoir « {$a->assignment} ».</p>
<p>Vous pouvez consulter le travail remis et son statut sur la <a href="{$a->url}">page du devoir</a>.</p>
...
$string['usersnone'] = 'Il n’y a pas d’utilisateur inscrit à ce cours.';
