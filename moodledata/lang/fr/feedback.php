...
/**
 * Strings for component 'feedback', language 'fr', version '5.0'.
 *
 * @package     feedback
 * @category    string
...
$string['append_new_items'] = 'Conserver les questions existantes et ajouter les nouvelles questions à la fin';
...
$string['availableforallcourses'] = 'Disponible pour tous les cours';
...
$string['coursetemplates'] = 'Modèles de cours';
...
$string['delete_old_items'] = 'Écraser les anciennes questions';
...
$string['previewtemplate'] = 'Aperçu du modèle « {$a} »';
...
$string['sitetemplates'] = 'Modèles du site';
...
$string['this_feedback_is_already_submitted'] = 'Vous avez déjà envoyé ce feedback.';
...
$string['whatfor'] = 'Comment appliquer ce modèle ?';
