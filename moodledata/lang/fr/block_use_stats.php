...
/**
 * Strings for component 'block_use_stats', language 'fr', version '5.0'.
 *
...
$string['configkeepaliveenable'] = 'Activer le maintien de la session';
$string['configkeepaliveenable_desc'] = 'La méthode Session keepalive enverra constamment des impulsions de suivi à Moodle lorsqu\'un utilisateur visualise un écran Moodle sur son terminal. Notez que cette méthode doit être utilisée avec précaution, car elle peut mesurer des comportements locaux incohérents.';
...
$string['privacy:metadata'] = 'Le bloc Use Stats ne stocke pas directement de données appartenant aux utilisateurs.';
...
$string['warningusestateenrolfilter'] = 'Le vérificateur d\'inscription est activé dans le bloc Utilisation des statistiques. Cela peut avoir des effets sur les rapports si l\'activité de l\'utilisateur est antérieure à la dernière date de début d\'inscription.';
