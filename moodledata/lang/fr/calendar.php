...
/**
 * Strings for component 'calendar', language 'fr', version '5.0'.
 *
 * @package     calendar
 * @category    string
...
$string['timerelativetoday'] = 'Aujourd’hui, {$a}';
$string['timerelativetomorrow'] = 'Demain, {$a}';
$string['timerelativeyesterday'] = 'Hier, {$a}';
