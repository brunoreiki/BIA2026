...
/**
 * Strings for component 'report_coursemanager', language 'fr', version '5.0'.
 *
...
$string['delete_cohort_confirm'] = 'À l’aide de cette fonction, vous avez la possibilité de désinscrire les étudiants en supprimant les cohortes invitées dans votre cours.<br />
...
$string['delete_send_mail_desc'] = 'Sélectionnez le ou les rôles qui seront avertis par courriel lors de la suppression d’un cours';
...
$string['enablemailing_desc'] = 'Si coché, active l’envoi des rapports de cours à chaque enseignant. La périodicité du mailing est définie par défaut tous les 30 jours, et peut être modifiée dans les tâches programmées.';
...
$string['last_access_multiple_teacher_alert'] = '<b>Pas de visites d’enseignant depuis plus de {$a->limit_visit} mois.</b><br />Aucun enseignant inscrit n’a visité ce cours durant cette période. Si personne ne l’utilise, pensez à le supprimer.';
...
$string['mailingintro_setting'] = 'Introduction du courriel';
...
<p>Si vous ne souhaitez pas réinitialiser tous ces éléments ou si vous souhaitez vider d’autres contenus (wiki, bases de données…), il vous est possible de <a href="/course/view.php?id="><b>sélectionner les éléments que vous souhaitez réinitialiser</b></a> depuis la fonction disponible dans votre cours.<br />
Vous pouvez également choisir de <b>désinscrire uniquement vos cohortes</b> sans toucher aux contenus. Il est à noter que désinscrire des étudiants fait également disparaître les données des étudiants.</p>
...
<p><b>Rappel</b> : aucune ressource ou activité n’a été supprimée. Seules les données personnelles des activités devoirs, quiz et forum, ainsi que les notes et
 les cohortes ont été retirées. Si vous souhaitez réinitialiser d’autres activités (wiki, feedback, base de données…), utilisez la fonction de réinitialisation depuis votre cours.</p>';
