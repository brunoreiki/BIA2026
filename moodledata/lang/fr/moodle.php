...
/**
 * Strings for component 'moodle', language 'fr', version '5.0'.
 *
 * @package     moodle
 * @category    string
...
$string['count_of_total'] = '<strong>{$a->count}</strong> sur {$a->total}';
...
$string['datetimefilterafter'] = 'Après {$a->title}';
$string['datetimefilterbefore'] = 'Avant {$a->title}';
$string['day'] = 'jour';
$string['days'] = 'jours';
...
$string['eventcourseoverviewviewed'] = 'Page de vue d’ensemble des activités de cours consultée';
...
$string['hidecategory'] = 'Cacher la catégorie ?';
$string['hidecategorymany'] = 'La catégorie {$a->category} contient {$a->coursecount} cours.
<br/>Si vous la cachez, les utilisateurs sans permission de voir les catégories cachées ne pourront plus avoir accès à ces cours.';
$string['hidecategoryone'] = 'La catégorie {$a->category} contient 1 cours.
<br/>Si vous la cachez, les utilisateurs sans permission de voir les catégories cachées ne pourront plus avoir accès à ce cours.';
...
$string['modhidden'] = 'Disponibilité';
$string['modhidden_help'] = '* Cacher sur la page de cours : non disponible pour les étudiants. Ce module ne peut pas être affichés pour les étudiants.';
...
$string['moveitemdown'] = 'Déplacer {$a} vers le bas';
$string['moveitemup'] = 'Déplacer {$a} vers le haut';
...
$string['resource_type'] = 'Type de ressource';
...
$string['selectdates'] = 'Sélectionner des dates';
...
$string['showpopovermenu'] = 'Ouvrir la fenêtre contextuelle';
