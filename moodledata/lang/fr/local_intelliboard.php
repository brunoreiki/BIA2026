...
/**
 * Strings for component 'local_intelliboard', language 'fr', version '5.0'.
 *
...
$string['instructor_course_visibility'] = 'Afficher les cours masqués/suspendus pour [enseignant]';
...
$string['instructor_custom_groups'] = 'Groupes personnalisés d’enseignant';
...
$string['instructor_mode'] = 'Afficher tous les cours disponibles pour [enseignant]';
$string['instructor_mode_access'] = 'Afficher tous les cours disponibles pour [enseignant] avec les autorisations [mise à jour]';
$string['instructor_redirect'] = 'Redirection de l’enseignant vers le tableau de bord';
...
$string['intellicart_instructor_integration'] = 'Intégration avec le tableau de bord de l’enseignant';
...
$string['n10'] = 'Tableau de bord de l’enseignant';
...
$string['te1_desc'] = 'Entrez le prénom, le nom, le courriel utilisé avec l’abonnement IntelliBoard.net. Si vous n’avez pas d’abonnement actif, inscrivez-vous sur <a target="_blank" href="https://intelliboard.net"> IntelliBoard.net </a>. Les tableaux de bord de l’apprenant et de l’enseignant ne sont pas actifs par défaut.';
