...
/**
 * Strings for component 'repository_nextcloud', language 'fr', version '5.0'.
 *
...
$string['right_issuers'] = 'Les fournisseurs suivants implémentent les points de terminaison requis :<br />{$a}';
$string['supportedreturntypes'] = 'Fichier pris en charge';
