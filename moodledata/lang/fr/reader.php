...
/**
 * Strings for component 'reader', language 'fr', version '5.0'.
 *
 * @package     reader
 * @category    string
...
$string['noemailever'] = 'L’envoi de courriel est désactivé en raison de la configuration de la variable $CFG->noemailever';
...
$string['pleaseaskyourinstructor'] = 'Si c’est trop facile pour vous, veuillez demander à votre enseignant d’augmenter votre niveau.';
...
$string['select_help'] = 'Cliquez sur le type d’élément que vous souhaitez sélectionner dans la liste ci-dessous.';
...
$string['show_help'] = 'Cliquez sur le type d’élément que vous souhaitez voir apparaître dans la liste ci-dessous';
