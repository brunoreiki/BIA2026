...
/**
 * Strings for component 'block_stash', language 'fr', version '5.0'.
 *
 * @package     block_stash
 * @category    string
...
$string['alluseritemsreset'] = 'Tous les éléments pour tous les utilisateurs ont été réinitialisés.';
...
$string['reallyresetusersitems'] = 'Cela supprimera tous les éléments de tous les utilisateurs de ce cours. Il est fortement recommandé de sauvegarder le cours avant d\'effectuer cette action. Si vous répondez oui, la réinitialisation des éléments des utilisateurs se poursuivra.';
...
$string['resetallusersitems'] = 'Réinitialiser tous les éléments des utilisateurs';
