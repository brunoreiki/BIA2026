...
/**
 * Strings for component 'peerwork', language 'fr', version '5.0'.
 *
 * @package     peerwork
 * @category    string
...
$string['confirmlockeditingaware'] = 'Vous ne serez plus autorisé à apporter des modifications à votre dépôt et aux notes de vos pairs une fois qu’ils auront été enregistrés. Voulez-vous vraiment continuer ?';
...
$string['justificationnoteshidden'] = 'À noter : vos commentaires seront cachés à vos camarades et ne seront visibles que par les enseignants.';
$string['justificationnotesvisibleanon'] = 'À noter : vos commentaires seront visibles par vos pairs mais anonymes, votre nom d’utilisateur n’apparaîtra pas à côté des commentaires que vous laisserez.';
$string['justificationnotesvisibleuser'] = 'À noter : vos commentaires et votre nom d’utilisateur seront visibles par vos pairs.';
