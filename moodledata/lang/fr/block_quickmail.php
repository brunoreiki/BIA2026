...
/**
 * Strings for component 'block_quickmail', language 'fr', version '5.0'.
 *
...
$string['additional_emails_help'] = 'Autres adresses de courriel vers lesquelles vous souhaiteriez envoyer le message (séparez ces adresses par une virgule ou un point virgule). Exemple :
...
$string['altsendfrom'] = 'Autoriser les courriels secondaires';
$string['altsendfrom_desc'] = 'Permettre les courriels secondaires (nécessite une modification du noyau pour cela).';
...
$string['invalid_condition_grade_greater_than'] = 'Note non valide supérieure à la valeur.';
$string['invalid_condition_grade_less_than'] = 'Note non valide inférieure à la valeur.';
...
$string['invalid_email'] = 'Adresse courriel non valide';
...
$string['message_type_available_email'] = 'Restreindre au courriel traditionnel uniquement';
$string['message_type_available_message'] = 'Restreindre aux seuls messages Moodle';
$string['message_type_desc'] = 'Permet d’envoyer des messages Quickmail sous forme de message Moodle, de courriel traditionnel ou selon les préférences de l’expéditeur.';
$string['message_type_email'] = 'Courriel';
$string['message_type_message'] = 'Message Moodle';
...
$string['send_now_scheduled_modal_title'] = 'Envoyer le message maintenant';
