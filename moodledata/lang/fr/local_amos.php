...
/**
 * Strings for component 'local_amos', language 'fr', version '5.0'.
 *
 * @package     local_amos
 * @category    string
...
$string['amos:editlangconfig'] = 'Modifier les chaînes de configuration du paquetage de langue';
...
$string['cachedef_lists'] = 'Liste des langues et composants connus dans AMOS';
...
$string['componentsadditional'] = 'Additionnel';
...
Veuillez à l’avenir contrôler d’avoir sélectionné le paquetage de langue correct avant de traduire les chaînes.
...
$string['filtermisfworkplace_help'] = 'Cette chaîne de caractères est utilisée dans Moodle Workplace sous le nom {$a}';
...
$string['filtertxteng'] = 'dans les chaînes anglaises';
$string['filtertxtregex'] = 'expression régulière';
$string['filtertxttra'] = 'dans les chaînes traduites';
...
$string['limitreachedmsg'] = 'Trop de résultats. Essayez de modifier les options de filtre pour restreindre la recherche.';
...
$string['privacy:metadata:db:amospreferences'] = 'Préférences AMOS pour l’utilisateur indiqué.';
$string['privacy:metadata:db:amospreferences:name'] = 'Nom de la préférence';
$string['privacy:metadata:db:amospreferences:value'] = 'Valeur de la préférence';
...
$string['privacy:metadata:db:amostranslators:status'] = 'Détermine si l’utilisateur est un mainteneur (0) ou un contributeur explicite (1) du paquetage de langue.';
...
* `theme_clean 25 -36` - indique que le composant était standard de Moodle 2.5 jusqu’à Moodle 3.6 compris';
...
$string['unablelangconfig'] = 'Pas de permission pour modifier la configuration du paquetage de langue';
