...
/**
 * Strings for component 'mnet', language 'fr', version '5.0'.
 *
 * @package     mnet
 * @category    string
...
$string['privacy:metadata:mnet_external:autosubscribe'] = 'Un réglage déterminant si l’utilisateur doit être automatiquement abonné aux forums dans lesquels il écrit.';
$string['privacy:metadata:mnet_external:calendartype'] = 'Un réglage utilisateur du type de calendrier à utiliser.';
$string['privacy:metadata:mnet_external:city'] = 'La ville de l’utilisateur.';
$string['privacy:metadata:mnet_external:country'] = 'Le pays de résidence de l’utilisateur.';
$string['privacy:metadata:mnet_external:currentlogin'] = 'La connexion actuelle de l’utilisateur.';
$string['privacy:metadata:mnet_external:department'] = 'Le service dans lequel se trouve l’utilisateur.';
$string['privacy:metadata:mnet_external:description'] = 'Des informations générales sur l’utilisateur.';
$string['privacy:metadata:mnet_external:email'] = 'Une adresse de courriel de contact.';
$string['privacy:metadata:mnet_external:emailstop'] = 'Un réglage permettant de stopper l’envoi de courriels à l’utilisateur.';
$string['privacy:metadata:mnet_external:firstaccess'] = 'L’horodatage du premier accès à ce site par l’utilisateur.';
$string['privacy:metadata:mnet_external:firstname'] = 'Le prénom de l’utilisateur.';
$string['privacy:metadata:mnet_external:firstnamephonetic'] = 'Les informations phonétiques du prénom de l’utilisateur.';
$string['privacy:metadata:mnet_external:id'] = 'L’identifiant de l’utilisateur.';
$string['privacy:metadata:mnet_external:idnumber'] = 'Un numéro d’identification attribué par l’institution.';
$string['privacy:metadata:mnet_external:imagealt'] = 'Un texte alternatif pour l’avatar de l’utilisateur.';
$string['privacy:metadata:mnet_external:institution'] = 'L’institution dont l’utilisateur est membre.';
$string['privacy:metadata:mnet_external:lang'] = 'Un réglage utilisateur pour la langue d’affichage.';
$string['privacy:metadata:mnet_external:lastaccess'] = 'L’horodatage du dernier accès à ce site par l’utilisateur.';
...
$string['privacy:metadata:mnet_external:lastnamephonetic'] = 'Les informations phonétiques du nom de famille de l’utilisateur.';
$string['privacy:metadata:mnet_external:maildigest'] = 'Un réglage pour les courriels récapitulatifs de cet utilisateur.';
$string['privacy:metadata:mnet_external:maildisplay'] = 'Un réglage utilisateur pour l’affichage de sa propre adresse de courriel aux autres utilisateurs.';
...
$string['privacy:metadata:mnet_external:picture'] = 'Les informations de l’avatar associé à l’utilisateur.';
$string['privacy:metadata:mnet_external:policyagreed'] = 'Un indicateur indiquant si l’utilisateur a accepté la politique du site.';
$string['privacy:metadata:mnet_external:suspended'] = 'Un indicateur indiquant si l’utilisateur a été suspendu sur ce site.';
$string['privacy:metadata:mnet_external:timezone'] = 'Le fuseau horaire de l’utilisateur.';
$string['privacy:metadata:mnet_external:trackforums'] = 'Un réglage pour le suivi sur les forums.';
$string['privacy:metadata:mnet_external:trustbitmask'] = 'Le masque du bit de confiance.';
$string['privacy:metadata:mnet_external:username'] = 'Le nom d’utilisateur de l’utilisateur.';
$string['privacy:metadata:mnet_log'] = 'Des informations sur les actions effectuées à distance par un utilisateur local connecté sur un système distant.';
...
$string['privacy:metadata:mnet_log:course'] = 'L’ID du cours où l’action est survenue, sur le système distant';
$string['privacy:metadata:mnet_log:coursename'] = 'Le nom complet du cours où l’action est survenue, sur le système distant';
$string['privacy:metadata:mnet_log:hostid'] = 'L’ID MNet du système distant.';
$string['privacy:metadata:mnet_log:info'] = 'Informations supplémentaires sur l’action.';
$string['privacy:metadata:mnet_log:ip'] = 'L’adresse IP utilisée au moment de l’action.';
$string['privacy:metadata:mnet_log:module'] = 'Le module du système distant où l’action est survenue.';
$string['privacy:metadata:mnet_log:remoteid'] = 'L’ID distant de l’utilisateur qui a effectué l’action sur le système distant.';
$string['privacy:metadata:mnet_log:time'] = 'L’horodatage de l’action.';
$string['privacy:metadata:mnet_log:url'] = 'L’URL du système distant où l’action est survenue.';
$string['privacy:metadata:mnet_log:userid'] = 'L’ID local de l’utilisateur qui a effectué l’action sur le système distant.';
$string['privacy:metadata:mnet_session'] = 'Les infos de chaque session utilisateur MNET dans un système distant. Les données sont enregistrées de manière temporaire.';
$string['privacy:metadata:mnet_session:expires'] = 'L’horodatage de l’échéance de la session.';
$string['privacy:metadata:mnet_session:mnethostid'] = 'L’ID MNet du système distant.';
$string['privacy:metadata:mnet_session:token'] = 'Identifiant unique de session';
$string['privacy:metadata:mnet_session:useragent'] = 'L’agent utilisateur utilisé pour accéder au système distant.';
$string['privacy:metadata:mnet_session:userid'] = 'L’ID de l’utilisateur accédant au système distant.';
$string['privacy:metadata:mnet_session:username'] = 'Le nom d’utilisateur de l’utilisateur accédant au système distant.';
