...
/**
 * Strings for component 'badges', language 'fr', version '5.0'.
 *
 * @package     badges
 * @category    string
...
$string['badgeimageinfo'] = 'Pour de meilleurs résultats, déposer une image carrée d’une taille minimale de 300 x 300 pixels.';
...
$string['descriptioninfo'] = 'Que représente ce badge ?';
...
$string['fixed'] = 'Date fixe : ce badge arrive à échéance à la date suivante :';
$string['hidden'] = 'Caché';
...
$string['never'] = 'Jamais : ce badge n’arrive jamais à échéance.';
...
$string['relative'] = 'Date relative : ce badge arrive à échéance après une certaine durée :';
