...
/**
 * Strings for component 'tool_task', language 'fr', version '5.0'.
 *
 * @package     tool_task
 * @category    string
...
$string['confirmdeletetaskwithid'] = 'Voulez-vous vraiment supprimer la tâche d’identifiant : {$a->id} ?';
...
$string['deleteadhoctask'] = 'Supprimer la tâche ad hoc {$a}';
...
$string['runclassnamedueonly'] = 'Ne lancer que les tâches en retard';
