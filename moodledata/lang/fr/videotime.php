...
/**
 * Strings for component 'videotime', language 'fr', version '5.0'.
 *
 * @package     videotime
 * @category    string
...
$string['invalid_session_state'] = 'État de session non valide';
...
$string['vimeo_url_invalid'] = 'URL Vimeo non valide. Copiez-la directement depuis votre navigateur.';
