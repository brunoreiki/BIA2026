...
/**
 * Strings for component 'enrol_fee', language 'fr', version '5.0'.
 *
 * @package     enrol_fee
 * @category    string
...
$string['instancedescription'] = 'Description de l’instance';
$string['instancedescription_help'] = 'La description n’est affichée que sur la page « Méthodes d’inscription » et n’est pas visible pour les utilisateurs qui s’inscrivent au cours.';
