...
/**
 * Strings for component 'readaloud', language 'fr', version '5.0'.
 *
 * @package     readaloud
 * @category    string
...
$string['admintabinstructions'] = 'Sur cette page, vous pouvez modifier les alternatives pour le passage tout en visualisant un résumé des erreurs de transcription. Lorsque vous sauvegardez, toutes les tentatives seront réévaluées et les notes ajustées seront ajoutées au carnet de notes.';
...
$string['applysettingsrange'] = 'Appliquer le réglage à :';
...
$string['close'] = 'Fermer';
$string['confirmitemdelete'] = 'Voulez-vous vraiment <i>SUPPRIMER</i> l’élément ? : {$a}';
...
$string['courseattempts_explanation'] = 'Toutes les tentatives d’activités de lecture à voix haute dans le cadre de ce cours';
$string['courseattemptsheading'] = 'Rapport sur les tentatives de cours';
$string['courseattemptsreport'] = 'Rapport sur les tentatives de cours';
...
$string['privacy:metadata'] = 'Le plugin Poodll Read Aloud enregistre des données personnelles.';
