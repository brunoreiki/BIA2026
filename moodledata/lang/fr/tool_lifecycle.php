...
/**
 * Strings for component 'tool_lifecycle', language 'fr', version '5.0'.
 *
...
$string['abortdisableworkflow_confirm'] = 'La chaîne de traitement va être désactivée et tous les processus en cours de cette chaîne seront interrompus. Le voulez-vous vraiment ?';
$string['abortprocesses'] = 'Abandonner les processus en cours (potentiellement dangereux !)';
$string['abortprocesses_confirm'] = 'Tous les processus en cours de cette chaîne de traitement seront interrompus. Le voulez-vous vraiment ?';
...
$string['deleteworkflow_confirm'] = 'La chaîne de traitement va être effacée. C’est irréversible. Le voulez-vous vraiment ?';
$string['disableworkflow'] = 'Désactiver la chaîne de traitement (les processus continuent de fonctionner)';
$string['disableworkflow_confirm'] = 'La chaîne de traitement va être désactivée. Le voulez-vous vraiment ?';
...
$string['invalid_workflow'] = 'Configuration non valide de la chaîne de traitement';
