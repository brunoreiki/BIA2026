...
/**
 * Strings for component 'block_dash', language 'fr', version '5.0'.
 *
 * @package     block_dash
 * @category    string
...
$string['addjointable'] = 'Ajouter {no} table de jointure au formulaire';
...
$string['anothertrailpath'] = 'Nouvel essai';
$string['arrows'] = 'Afficher les flèches';
$string['arrows_help'] = 'Afficher les boutons fléchés pour la navigation dans les diapositives suivante/précédente.';
$string['asc'] = 'Ascendant';
$string['attribute'] = 'Attribut';
$string['auto'] = 'Auto';
$string['autoplay'] = 'Lecture automatique';
$string['autoplaySpeed'] = 'Vitesse de lecture automatique (ms)';
$string['autoplaySpeed_help'] = 'Définissez la vitesse de lecture automatique en millisecondes.';
$string['autoplay_help'] = 'Lecture automatique';
...
$string['backgroundimageurl'] = 'URL de l’image de fond';
$string['backgroundposition'] = 'Position d’arrière-plan';
$string['backgroundposition_help'] = 'L’image d’arrière-plan se concentrera sur la position donnée';
$string['backgroundsize'] = 'Taille de l’arrière-plan';
$string['backgroundsize_help'] = 'L’image d’arrière-plan s’affichera dans la taille';
...
$string['border_option'] = 'Afficher la bordure';
$string['border_option_help'] = 'Possibilité d’ajouter la bordure du bloc de tiret.';
$string['bordervalue'] = 'Valeur limite';
...
$string['categories_help'] = 'La source de données Catégories répertorie les catégories disponibles';
$string['category'] = 'Nom de catégorie';
$string['categorycoursecount'] = 'Les cours comptent';
$string['categoryimage'] = 'Image de catégorie';
$string['categoryimagelink'] = 'Lien de catégorie';
$string['categoryimageurl'] = 'URL de l’image de la catégorie';
$string['categoryimgcategory'] = 'Image pour la catégorie {$a->category}';
$string['categoryimgdesc'] = 'Ajouter des images pour les catégories';
$string['categoryimgfallback'] = 'Image de secours de la catégorie';
$string['categoryimgfallbackdesc'] = 'Téléchargez l’image pour le remplacement par défaut des catégories. Si de nouvelles catégories sont créées, l’image de secours sera affichée jusqu’à ce qu’une nouvelle image soit ajoutée pour la catégorie';
$string['categoryimgheading'] = 'Image de catégorie';
$string['categoryimgheadingsub'] = 'Images de catégories';
$string['categoryurl'] = 'URL de la catégorie';
$string['centerMode'] = 'Mode centré';
$string['centerMode_help'] = 'Permet une vue centrée avec des diapositives partielles précédentes/suivantes. À utiliser avec des nombres impairs de diapositives.';
$string['centerPadding'] = 'Remplissage central (px)';
$string['centerPadding_help'] = 'Remplissage latéral en mode central (px).';
$string['centerbottom'] = 'Centre bas';
$string['centercenter'] = 'Centre Centre';
$string['centertop'] = 'Centre Haut';
$string['certificatecodelinked'] = 'Code lié';
...
$string['chooseskill'] = 'Choisir la compétence';
$string['circlepath'] = 'Cercle';
