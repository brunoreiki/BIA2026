...
/**
 * Strings for component 'tool_certificate', language 'fr', version '5.0'.
 *
...
$string['invalidcolour'] = 'Couleur non valide choisie. Veuillez entrer un nom de couleur HTML valide ou une couleur hexadécimale à six ou trois chiffres.';
...
$string['mycertificatesdescription'] = 'Il s’agit des certificats qui vous ont été délivrés soit par courriel, soit par téléchargement manuel.';
$string['name'] = 'Nom';
