...
/**
 * Strings for component 'quiz_group', language 'fr', version '5.0'.
 *
 * @package     quiz_group
 * @category    string
...
$string['warning_group'] = 'Attention : <ul> <li>Le test en groupe utilise un groupement spécifique. Assurez vous de donner les accès appropriés dans la section "Restreindre l’accès" dans les paramètres du quiz.</li><li>Si un étudiant est dans plusieurs groupes d’un même groupement, le système ne considèrera que sa première affiliation.</li><li>Ne pas changer le groupement si des tentatives sont déjà enregistrées pour ce test !</li></ul>';
