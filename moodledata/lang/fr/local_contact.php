...
/**
 * Strings for component 'local_contact', language 'fr', version '5.0'.
 *
...
$string['attachment'] = 'Autoriser les pièces jointes';
$string['attachment_description'] = 'Lorsque cette option est activée, Contact Form prend en charge une pièce jointe. Voir README.md pour plus de détails sur la façon d’ajouter le support d’une pièce jointe à votre formulaire.';
