...
/**
 * Strings for component 'report_overviewstats', language 'fr', version '5.0'.
 *
...
$string['chart-courses-sizes'] = 'Nombre de cours par nombre d’activités';
$string['chart-courses-sizes_help'] = 'Affiche le diagramme de distribution du nombre d’activités par cours. C’est-à-dire, le nombre de cours ayant 0-4 activités, 5-9 activités, 10-14 activités, etc.';
...
$string['course-numbers'] = 'Nombre de cours';
$string['enrolled'] = 'Inscrits';
$string['null-course-exception'] = 'Rapport au niveau du cours invoqué sans référence au cours !';
$string['overviewstats:view'] = 'Visualiser l’aperçu des statistiques';
$string['pluginname'] = 'Aperçu des statistiques';
$string['privacy:metadata'] = 'Le plugin Aperçu des statistiques n’enregistre aucune donnée personnelle.';
$string['user-numbers'] = 'Nombre d’utilisateurs';
