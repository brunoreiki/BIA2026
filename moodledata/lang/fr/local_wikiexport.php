...
/**
 * Strings for component 'local_wikiexport', language 'fr', version '5.0'.
 *
...
$string['sortpagesintro'] = 'C’est l’ordre dans lequel les pages seront exportées - veuillez déplacer les pages dans l’ordre où vous souhaitez qu’elles soient exportées';
