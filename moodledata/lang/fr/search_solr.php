...
/**
 * Strings for component 'search_solr', language 'fr', version '5.0'.
 *
 * @package     search_solr
 * @category    string
...
$string['check_indextoobig'] = 'Index plus grand que la taille spécifiée';
$string['check_nocore'] = 'Impossible de trouver l’index sur le serveur Solr';
$string['check_nosize'] = 'Impossible de déterminer la taille de l’index sur le serveur Solr';
$string['check_notconnected'] = 'Impossible de se connecter au serveur Solr';
$string['check_time'] = 'Le serveur a répondu avec le statut de {$a}';
...
$string['indexsize'] = 'L’index utilise {$a} sur le serveur Solr';
$string['indexsizelimit'] = 'Taille limite de l’index';
$string['indexsizelimit_desc'] = 'Affiche une erreur sur la page de statut d’erreur si l’index devient plus grand que cette taille (en octets), et une avertissement s’il dépasse 90 %. Indiquer 0 pour aucune limite de taille d’index.';
