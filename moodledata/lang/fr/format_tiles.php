...
/**
 * Strings for component 'format_tiles', language 'fr', version '5.0'.
 *
...
$string['folderdisplayerror'] = 'Les dossiers dont le contenu est affiché en ligne ne sont pas compatibles avec le format des sous-titres.  Par exemple, le dossier « {$a} » doit être modifié pour afficher le contenu sur une page séparée.';
...
$string['restoretoomanysections'] = 'Erreur : Impossible de sauvegarder ou de restaurer car trop de sections de cours sont incluses (max {$a}).  Essayez d\'exclure ou de supprimer certaines sections.';
...
$string['usejavascriptnav'] = 'Utiliser la navigation animée à partir de la page principale des Tuiles';
$string['usejavascriptnav_desc'] = 'Si cette option est cochée, si l\'utilisateur clique sur une tuile de la page principale de présentation du cours et s\'il dispose de JavaScript, ce dernier sera utilisé pour passer au contenu de la tuile.  Si la case n\'est pas cochée, JS ne sera pas utilisé et la navigation traditionnelle (chargement de page PHP) sera utilisée à la place.  Les autres paramètres JS ci-dessous seront ignorés.';
