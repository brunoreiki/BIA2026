...
/**
 * Strings for component 'cachestore_file', language 'fr', version '5.0'.
 *
...
$string['useserializer'] = 'Utiliser un sérialiseur';
$string['useserializer_help'] = 'Le sérialiseur à utiliser. Le sérialiseur igbinary, si disponible, peut réduire les besoins en stockage des grands caches. Ceci n’est pris en charge que si l’extension igbinary est chargée.';
