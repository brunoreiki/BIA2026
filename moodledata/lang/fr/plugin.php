...
/**
 * Strings for component 'plugin', language 'fr', version '5.0'.
 *
 * @package     plugin
 * @category    string
...
$string['deprecated_type'] = 'Type de plugin obsolète';
...
$string['type_gradepenalty'] = 'Pénalité de note';
$string['type_gradepenalty_plural'] = 'Pénalités de note';
