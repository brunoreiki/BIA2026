...
/**
 * Strings for component 'course', language 'fr', version '5.0'.
 *
 * @package     course
 * @category    string
...
$string['customfield_islocked_help'] = 'Si le champ est verrouillé, seuls les gestionnaires avec la capacité de modifier les champs de cours personnalisés verrouillés (ceux qui ont le rôle de gestionnaire) pourront le modifier dans le formulaire d’édition du cours.';
...
$string['overview_info'] = 'Une vue d’ensemble de toutes les activités du cours, avec les dates et d’autres informations.';
$string['overview_missing_notice'] = 'Aller à {$a}.';
$string['overview_missing_title'] = 'Informations sur {$a} non disponibles.';
$string['overview_modname'] = 'Vue d’ensemble de {$a}';
$string['overview_page_title'] = 'Activités du cours : {$a}';
$string['overview_table_caption'] = 'Tableau répertoriant les {$a} activités';
