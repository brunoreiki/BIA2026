...
/**
 * Strings for component 'cobra', language 'fr', version '5.0'.
 *
 * @package     cobra
 * @category    string
...
$string['cobranavigation'] = 'Navigation tertiaire pour CoBRA';
...
$string['defaultflag2'] = 'Conserver par défaut';
$string['defaultflag2_help'] = 'Conserver ces paramètres par défaut pour les textes futurs';
...
$string['timeout_desc'] = 'Timeout maximum pour des requêtes Curl';
