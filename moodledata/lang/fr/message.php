...
/**
 * Strings for component 'message', language 'fr', version '5.0'.
 *
 * @package     message
 * @category    string
...
$string['notsupported'] = 'Non pris en charge';
...
$string['successproviderenabled'] = '« {$a->provider} » pour « {$a->processor} » modifié.';
$string['successproviderlocked'] = '« {$a->provider} » pour « {$a->processor} » verrouillé.';
$string['successproviderunlocked'] = '« {$a->provider} » pour « {$a->processor} » déverrouillé.';
$string['successproviderupdate'] = '« {$a} » modifié.';
...
$string['unsentmessagenotification'] = 'Un message n’a pas été envoyé. Il sera perdu si vous quittez cette page.';
