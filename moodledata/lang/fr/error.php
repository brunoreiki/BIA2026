...
/**
 * Strings for component 'error', language 'fr', version '5.0'.
 *
 * @package     error
 * @category    string
...
$string['invaliddatetimebetween'] = '{$a->after} doit être antérieure à {$a->before}.';
$string['invaliddatetimemode'] = 'Filtre de date de modification non valide : {$a}';
