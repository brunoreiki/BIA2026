...
/**
 * Strings for component 'filter_filtercodes', language 'fr', version '5.0'.
 *
...
<ul>
<li><strong>Vertical</strong> : Image du cours au-dessus du nom du cours ;</li>
<li><strong>Horizontal</strong> : image du cours à gauche du nom du cours, de la catégorie et du résumé ; ou</li>
<li><strong>Liste</strong> dans un tableau : Nom du cours, catégorie et résumé.</li>
</ul>';
...
$string['nocompletedcourses'] = 'Aucun des cours auxquels vous êtes inscrit n’a été marqué comme terminé.';
...
$string['wishlist'] = 'Liste de souhaits';
$string['wishlist_add'] = 'Ajouter ce cours à la liste';
$string['wishlist_nocourses'] = 'Pas de cours dans la liste';
$string['wishlist_remove'] = 'Supprimer ce cours de la liste';
