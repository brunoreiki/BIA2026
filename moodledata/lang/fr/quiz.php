...
/**
 * Strings for component 'quiz', language 'fr', version '5.0'.
 *
 * @package     quiz
 * @category    string
...
$string['banknotfound'] = 'Banque de questions introuvable ; veuillez chercher à nouveau';
...
$string['cannoteditafterattempts'] = 'Vous ne pouvez pas ajouter ou retirer des questions, car ce test a des tentatives ({$a}).';
...
$string['configintroglobal'] = 'Ces réglages déterminent les comportements des activités Test au niveau du système.';
...
$string['currentbank'] = 'Banque actuelle : {$a}';
...
$string['defaultsettings'] = 'Réglages de test par défaut';
...
$string['eventquizattemptgraded'] = 'Tentative de test évaluée';
...
$string['overridesnoneforgroups'] = 'Il n’y a pas de dérogation de groupe pour ce test.';
$string['overridesnoneforusers'] = 'Il n’y a pas de dérogation utilisateur pour ce test.';
...
$string['precreateattempts'] = 'Pré-créer des tentatives';
$string['precreateattempts_desc'] = 'La pré-création de tentatives permet d’optimiser la performance du site. En plus de l’activation de ce réglage, il faut fixer une période de pré-création des tentatives. Remarque : ce réglage ne s’applique qu’aux tests avec une date ou une heure d’ouverture.';
$string['precreateattempts_help'] = 'Pré-créer des tentatives aide à optimiser la performance du site. Les questions de test ne peuvent pas être modifiées une fois que le test a des tentatives.';
$string['precreateoff'] = 'Ne pas pré-créer de tentatives';
$string['precreateperiod'] = 'Période de pré-création de tentatives';
$string['precreateperiod_desc'] = 'Si votre site a des tests avec une date ou une heure d’ouverture et que de nombreux étudiants les commencent en même temps, il est possible d’améliorer la performance en pré-créant des tentatives. Choisissez une durée de pré-création avant l’ouverture du test pour pré-créer les tentatives. Une durée la plus courte possible est recommandées, car les questions d’un test ne peuvent plus être modifiées dès que le test a des tentatives. Les tentatives sont générées par une tâche programmée lancée par défaut toutes les heures. Pour pré-créer des tentatives lorsque le système est calme, par exemple pendant la nuit, fixer la période à 12 heures et ajuster l’heure de lancement de la tâche planifiée pour qu’elle s’exécute pendant les heures les plus calmes.';
$string['precreatetask'] = 'Pré-créer des tentatives';
$string['precreateusedefault'] = 'Utiliser le réglage par défaut du site ({$a})';
$string['precreateyes'] = 'Oui, {$a} heures avant l’ouverture du test';
...
$string['quizinvalidquestions'] = 'Le test a des questions avec des types non valides. Le type de question manquant doit être réinstallé ou les questions concernées retirées avant que le test ne puisse être utilisé.';
...
$string['reportusersall'] = 'tous les utilisateurs ayant une tentative de test';
$string['reportuserswith'] = 'utilisateurs inscrits ayant une tentative de test';
$string['reportuserswithorwithout'] = 'utilisateurs inscrits ayant ou non une tentative de test';
$string['reportuserswithout'] = 'utilisateurs inscrits sans tentative de test';
...
$string['selectquestionbank'] = 'Sélectionner une banque de questions';
...
$string['statenotstarted'] = 'Pas commencée';
$string['stateoptions'] = 'Options de statut de tentative';
$string['stateoptions_help'] = '* Pas commencée : la tentative a été créée automatiquement avant l’ouverture du test. L’étudiant n’a pas encore commencé la tentative.
* En cours : l’étudiant a commencé la tentative. Il a encore du temps pour l’envoyer.
* En retard : la tentative est commencée depuis plus longtemps que la durée impartie. L’étudiant peut encore l’envoyer durant le délai supplémentaire octroyé.
* Envoyée : l’étudiant a terminé et envoyé ses réponses. La tentative est mise en file d’attente pour évaluation automatique.
* Terminée : la tentative a été envoyée et l’évaluation automatique terminée.
* Jamais envoyée : l’étudiant a commencé la tentative mais ne l’a pas envoyée dans le temps imparti, ni dans le délai supplémentaire octroyé.';
$string['stateoverdue'] = 'En retard';
$string['stateoverduedetails'] = 'Doit être remis par {$a}';
$string['statesubmitted'] = 'Envoyée';
$string['status'] = 'État';
