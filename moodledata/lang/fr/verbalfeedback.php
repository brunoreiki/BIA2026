...
/**
 * Strings for component 'verbalfeedback', language 'fr', version '5.0'.
 *
...
$string['removecategories'] = 'Supprimer des catégories';
$string['removecriteria'] = 'Supprimer des critères';
$string['removeresponses'] = 'Supprimer des réponses';
$string['removesubmissions'] = 'Supprimer des remises';
$string['removesubratings'] = 'Supprimer des subratings';
$string['reportimage'] = 'Logo d’en-tête du rapport PDF';
$string['reportimage_desc'] = 'L’image à afficher comme logo d’en-tête dans les pdf téléchargés du feedback verbal.';
...
$string['verbalfeedback:can_participate'] = 'Participer à un feedback verbal';
$string['verbalfeedback:can_respond'] = 'Répondre à un feedback verbal';
...
$string['verbalfeedback:managetemplates'] = 'Gérer les modèles de feedback verbal';
