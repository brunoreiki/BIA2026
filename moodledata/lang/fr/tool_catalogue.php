...
/**
 * Strings for component 'tool_catalogue', language 'fr', version '5.0'.
 *
...
$string['aboutthisprogram'] = 'À propos de ce parcours';
$string['all'] = 'Tout';
$string['allavailablecourses'] = 'Tous les cours disponibles';
...
$string['coursecoverhelp'] = 'Ce cours fait partie du parcours « {$a} »';
...
$string['proceedtoprogram'] = 'Passer au contenu du parcours';
$string['program'] = 'Parcours';
$string['programhelptext'] = '<ul><li>Les parcours peuvent contenir divers cours</li><li>Terminer les cours pour terminer le parcours</li></ul>';
$string['programhelptitle'] = 'Qu’est-ce qu’un parcours ?';
$string['programlink'] = 'Voir « {$a} » pour des détails';
$string['programlinksingle'] = 'Voir les détails du parcours';
$string['programs'] = 'Programmes';
$string['programstructure'] = 'Structure du parcours';
...
$string['todo'] = 'À faire :';
$string['trydifferentskeyword'] = 'Essayer en utilisant des mots clés ou un filtre de configuration différent';
