...
/**
 * Strings for component 'local_obf', language 'fr', version '5.0'.
 *
 * @package     local_obf
 * @category    string
...
$string['apidataretrievelocal'] = 'Montrer seulement les badges produits par ce système';
...
$string['badgependinginformationmessage'] = 'Cette section affiche la liste des badges en attente de délivrance. Dans certains cas, la délivrance peut être retardée, notamment en cas d’indisponibilité du serveur ou si l’abonnement du client est inactif.';
...
$string['choosebadgeissuer'] = 'Émetteur du badge';
$string['choosebadgeissuer_help'] = 'L’organisation principale ou l’une de ses sous-organisations associées au badge peut être sélectionnée comme émetteur du badge.';
...
$string['connectionerror'] = 'Une erreur de connexion s’est produite. Cela peut être dû à un abonnement expiré ou à des serveurs inaccessibles. Si le problème persiste, veuillez contacter le support.';
...
$string['emailbutton'] = 'Afficher le message';
...
$string['emailverifytokenemailbody2'] = 'Veuillez vérifier votre adresse e-mail. Code de vérification :';
$string['emailverifytokenemailsubject'] = 'Vérification du courriel';
$string['error:nosuchfield'] = 'Pas de champ de ce type.';
$string['eventrevoked'] = 'Le badge a bien été révoqué pour {$a}';
...
$string['exportissuer'] = 'Émetteur';
$string['exportrecipients'] = 'Destinataires';
$string['exportsettings'] = 'Export de badges';
$string['failrecordlist'] = 'File des badges en attente de délivrance';
...
$string['infoconnectapi'] = 'Sélectionner la méthode d’authentification API. OAuth2 est recommandé en niveau Pro.';
$string['invalidalias'] = 'L’émetteur sélectionné n’est pas disponible pour ce badge.';
$string['invalidclientsecret'] = 'Cet ID client ou clé secrète est non valide.';
...
$string['legacyconnectionunavailable'] = 'La connexion utilisant l’ancienne API n’est plus prise en charge. Merci de supprimer la connexion existante et de vous authentifier à nouveau avec des clés OAuth2.';
$string['loadmorerecipients'] = 'Voir plus de destinataires';
...
$string['privacy:metadata:full_name'] = 'Nom complet';
$string['privacy:metadata:grade'] = 'Note';
$string['privacy:metadata:issue_date'] = 'Date de délivrance';
$string['privacy:metadata:name'] = 'Nom';
$string['privacy:metadata:subject'] = 'Objet';
$string['privacy:metadata:user_preferences'] = 'Préférences utilisateur';
$string['privacy:metadata:value'] = 'Valeur';
$string['privacy:metadata:verified'] = 'Vérifié.e';
$string['processobfissuefailedrecord'] = 'Relancer les émissions de badges OBF échouées';
$string['processobfissuefailedrecordlog'] = 'Erreur lors de la tentative de réémission du badge ID : {$a}. Cela peut être dû à une erreur de connexion au serveur ou à un abonnement client inactif.';
...
$string['recipients'] = 'Bénéficiaire(s)';
...
$string['reviewcriterionaftersave'] = 'Examiner la règle rétroactivement';
...
$string['revokeuserbadges'] = 'Révoquer le badge';
$string['rules'] = 'Règle';
...
$string['selectissuerheader'] = 'Sélectionner l\'émetteur';
...
$string['suborganization'] = 'Sous-organisations disponibles';
$string['tableheaderaction'] = 'Action';
$string['tableheadercourse'] = 'Cours';
$string['tableheaderdate'] = 'Date';
$string['tableheaderid'] = 'ID';
$string['tableheaderinfo'] = 'Info';
$string['tableheaderrecipients'] = 'Bénéficiaires';
$string['tableheaderstatus'] = 'Statut';
...
$string['unavailableinfo'] = 'Les informations de ce badge ne sont pas disponibles pour le moment. Cela peut être lié à une indisponibilité du serveur OBF ou à un abonnement client inactif.';
$string['unavailableserver'] = 'Le serveur de badges est actuellement inaccessible ou peut ne plus être disponible pour au moins un client. Veuillez vérifier les paramètres du plugin et, si le problème persiste, contacter le fournisseur de service concerné. Certaines fonctionnalités ou informations peuvent être indisponibles.';
$string['unavailableserverbadgelist'] = 'La liste des badges ne peut pas être affichée car le serveur OBF est actuellement inaccessible.';
