...
/**
 * Strings for component 'tool_coursearchiver', language 'fr', version '5.0'.
 *
...
$string['archivewarningemailsetting_help'] = 'Ceci est le contenu d’un courriel qui sera envoyé à tous les responsables d’un cours sélectionné pour être archivé.';
...
$string['attemptdeletingcourse'] = 'Suppression du cours : ({$a->id}) {$a->fullname}.';
...
$string['cli_question_deleteemail'] = 'Envoyer le courriel « Cours à supprimer » à ces {$a} utilisateurs de cours ?';
...
$string['confirmdelete'] = 'Voulez-vous vraiment supprimer ces fichiers archivés ?';
$string['confirmdownload'] = 'Voulez-vous vraiment télécharger ces fichiers archivés ?';
...
$string['confirmmessagedeleteemail'] = 'Envoyer un courriel de « suppression de cours en attente » à ces {$a} propriétaires de cours ?';
...
$string['coursearchiver:use'] = 'Utiliser l\'archiveur de cours';
...
$string['coursearchiverpath_help'] = 'Ce chemin d’accès est relatif au chemin racine';
...
$string['deletedarchiveemails'] = 'Adresses de courriel responsables';
$string['deleteemail'] = 'Envoyer les courriels de « Cours à supprimer »';
$string['deletewarningemailsetting'] = 'Courriel par défaut pour suppression de cours';
$string['deletewarningemailsetting_help'] = 'Contenu du courriel qui sera transmis aux propriétaires d\'un cours sélectionné pour suppression.';
$string['deletewarningemailsettingdefault'] = '%to

Nous vous informons que les cours Moodle suivants, cours dans lesquels vous êtes enseignants, seront bientôt supprimés.
Cela signifie que les cours seront retirés de Moodle. Si vous souhaitez exclure l’un des cours suivants de ce traitement, veuillez cliquer sur le lien à côté du cours.

%courses

Merci.';
$string['deletewarningsubject'] = 'Attention : des cours seront bientôt supprimés';
...
$string['errorsendingemail'] = 'Envoi du courriel à {$a->firstname} {$a->lastname} ({$a->email}) échoué.';
...
$string['hidewarningemailsetting_help'] = 'Ceci est le contenu d’un courriel qui sera envoyé à tous les responsables d’un cours sélectionné pour être caché.';
...
$string['optoutbyemaildisabled'] = 'L\'option d\'exclure par courriel est désactivée';
$string['optoutbyemailsetting'] = 'Désactiver l\'option d\'exclure par courriel';
$string['optoutbyemailsetting_help'] = 'Le corps du courriel aux propriétaires de cours contiendra un lien pour exclure les cours.';
$string['optoutdelete'] = 'Ne pas supprimer ce cours';
...
$string['results_deleteemail'] = 'Courriels d\'avertissement de suppression des cours envoyés : {$a}';
