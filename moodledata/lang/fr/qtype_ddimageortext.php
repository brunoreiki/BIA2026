...
/**
 * Strings for component 'qtype_ddimageortext', language 'fr', version '5.0'.
 *
...
$string['dropzonevisibility'] = 'Visibilité de la zone de dépôt';
$string['dropzonevisibility_help'] = 'Les zones de dépôt doivent-elles être transparentes afin de ne pas couvrir des parties de l’image de fond ? les éléments glissés s’accrocheront aux zones de dépôt voisines.';
$string['dropzonevisibility_hideoption'] = 'Zones de dépôt transparentes';
$string['dropzonevisibility_showoption'] = 'Afficher les zones de dépôt';
$string['dropzonevisibilitydesc'] = 'Les bords resteront visibles lors de l’édition de la question, afin d’aider au positionnement de la zone de dépôt.';
