...
/**
 * Strings for component 'quiz_answersheets', language 'fr', version '5.0'.
 *
...
2. Lorsque le rapport est prêt, téléchargez le [fichier d’instructions pour le téléchargement par lots]({$a->scripturl}) qui fournira à l’outil `save-answersheets` les étapes à réaliser.
