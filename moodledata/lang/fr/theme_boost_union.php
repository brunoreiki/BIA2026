...
/**
 * Strings for component 'theme_boost_union', language 'fr', version '5.0'.
 *
...
$string['activitypurposeheadingpleasenote'] = 'Remarque : sur la page d\'aperçu des activités d\'un cours, toutes les ressources, telles que « livre », sont regroupées dans une section « ressources ». Ainsi, le but de ces types d\'activité ne peut pas / n’a pas besoin d\'être modifié sur cette page. Vous pouvez simplement modifier la couleur de l\'icône « ressources » à l\'aide du paramètre ci-dessus.';
...
<ul><li>Les <em>régions de blocs extérieurs</em> sont placées sur les quatre côtés de la page Moodle. Ils peuvent être utilisés pour afficher des blocs qui accompagnent la page Moodle affichée mais n’appartiennent pas directement au contenu principal.</li>
<li>La <em>région de blocs d’en-tête</em> est placée entre la zone Extérieure (en haut) et la zone de contenu principale. Elle peut être utilisée pour afficher un bloc en tant qu’informations d’en-tête de cours.</li>
...
<li>Les <em>régions de blocs de pied de page</em> sont placées en bas de la page entre la zone Extérieure (en bas) et la note de bas de page. Trois zones de pied de page sont disponibles pour créer des colonnes si nécessaire.</li>
<li>La <em>région de blocs hors canevas</em> est en quelque sorte spéciale car elle survole toute la page Moodle en tant que tiroir. Le tiroir est ouvert par l’icône à 9 points tout à droite de la barre de navigation. Trois régions hors canevas sont disponibles pour créer des colonnes si nécessaire.</li></ul>
<p>À noter :</p>
<ul><li>Par défaut, toutes les régions de blocs supplémentaires sont désactivées. Les régions de bloc particulières sur les mises en page particulières peuvent être activées en fonction des besoins. Mieux vaut condenser autant que possible : un trop grand nombre de régions de blocs pourrait submerger les utilisateurs finaux.</li>
<li>Dès qu’une région de blocs supplémentaires est activée, elle est visible pour tous les utilisateurs authentifiés et modifiable par les enseignants et les gestionnaires (selon le fait que l’utilisateur particulier est autorisé à modifier la page Moodle particulière, bien sûr). Mais il existe également des fonctionnalités theme/boost_union:viewregion* et theme/boost_union:editregion* qui permettent d’affiner l’utilisation de chaque région de bloc en fonction de vos besoins.</li>
...
$string['blockregionsheading_guestrole'] = '<strong>Attention ! </strong><br />Sur les installations Boost Union qui ont été mises à niveau à partir d\'une version antérieure à Boost Union v5.0, les régions bloquées ne sont pas encore visibles par défaut pour les utilisateurs invités, car ces paramètres de visibilité par défaut ont été modifiés dans Boost Union v5.0. Vous pouvez corriger automatiquement les paramètres par défaut (et ainsi rendre les régions bloquées visibles pour les invités) ou conserver votre configuration de visibilité locale telle quelle (et ainsi vous écarter du texte explicatif ci-dessus).';
$string['blockregionsheading_guestrole_fix'] = 'Définissez le rôle invité pour utiliser les nouvelles valeurs par défaut.';
$string['blockregionsheading_guestrole_fixed'] = 'Le rôle d\'invité utilise désormais les nouveaux paramètres par défaut et la notification sur la page des paramètres sera supprimée.';
$string['blockregionsheading_guestrole_keep'] = 'Conservez le rôle d\'invité tel quel.';
$string['blockregionsheading_guestrole_kept'] = 'Le rôle d\'invité restera inchangé et la notification sur la page des paramètres sera supprimée dès maintenant.';
...
$string['boost_union:viewhintcourseguestenrol'] = 'Voir un indice concernant l’inscription des invités dans un cours visible';
...
$string['calendarbrandingheading'] = 'Apparence générale du calendrier';
$string['calendarbrandingtab'] = 'Apparence du calendrier';
...
$string['calendariconscolorsetting_desc'] = 'La couleur de certaines icônes utilisées dans les vues du calendrier. La couleur par défaut est le bleu, mais cela peut entrer en conflit avec les couleurs du calendrier que vous avez peut-être définies ci-dessus.';
...
$string['error:infobannerdismissnonotvalidnotset'] = 'Cette instance Boost Union n\'a pas été mise à niveau à partir d\'une version antérieure à Boost Union v5.0 ou les nouveaux paramètres par défaut du rôle invité ont déjà été pris en charge. Il n\'y a rien à faire ici.';
...
$string['outsideregionsverticalaligndefault'] = 'Aucun';
$string['outsideregionsverticalalignment'] = 'Alignement vertical des zones extérieures';
$string['outsideregionsverticalalignment_desc'] = 'Ce paramètre vous permet de contrôler si, sur les écrans plus grands, les zones de bloc « Extérieur (gauche) » et « Extérieur (droite) » doivent être alignées verticalement avec le contenu de la page ou non.';
...
$string['slideranimationsetting_desc'] = 'Ce paramètre permet de définir la transition entre les diapositives. « Glissement » produit un effet de glissement, « Fondu » applique un effet de fondu enchaîné.';
