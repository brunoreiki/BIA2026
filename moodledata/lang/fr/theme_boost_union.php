...
$string['activitypurposeheadingpleasenote'] = 'Remarque : sur la page d\'aperçu des activités d\'un cours, toutes les activités liées aux ressources, telles que « livre », sont regroupées dans une section « ressources ». Ainsi, l\'objectif de ces types d\'activités individuelles ne peut pas / n\'a pas besoin d\'être modifié sur cette page. Vous pouvez simplement modifier la couleur de l\'icône « ressources » à l\'aide du paramètre ci-dessus.';
...
$string['enableuploadedsnippets'] = 'Activer les extraits téléchargés';
$string['enableuploadedsnippets_desc'] = 'Ce paramètre permet d\'activer ou de désactiver le téléchargement d\'extraits SCSS ici, dans les paramètres de Boost Union. Si vous désactivez ce paramètre, le téléchargement d\'extraits SCSS n\'est plus possible et tous les extraits SCSS précédemment téléchargés sont ignorés et ne sont jamais ajoutés à la pile SCSS.';
...
$string['snippetsoverview_desc'] = 'Les extraits SCSS de Boost Union offrent la possibilité d\'ajouter de petites (ou légèrement plus grandes) quantités de SCSS au site Moodle. Cela peut être particulièrement utile pour corriger de petits problèmes visuels dans le cœur de Moodle ou pour ajouter des éléments esthétiques à votre site Moodle.';
$string['snippetsoverview_notes'] = 'Pour pouvoir utiliser les extraits SCSS, veuillez lire ces instructions de base :';
...
$string['snippetsuploadedsnippetsheading_desc'] = 'En plus des extraits SCSS intégrés qui sont officiellement gérés par l\'équipe Boost Union, il existe le <a href="{$a}" target="_blank">référentiel d\'extraits SCSS sur Github</a>, qui sert de centre communautaire pour les extraits SCSS Boost Union. Vous trouverez dans ce référentiel les instructions d\'utilisation des extraits SCSS de la communauté ainsi que le modèle pour créer vos propres extraits SCSS locaux.';
...
$string['uploadedsnippets_note'] = 'Vous trouverez la structure et la syntaxe des extraits SCSS Boost Union dans notre <a href="{$a->url}" target="_blank">référentiel d\'extraits SCSS</a>. Vous y trouverez également des instructions sur la manière d\'utiliser les extraits existants de la communauté et de contribuer à celle-ci.';
