...
/**
 * Strings for component 'theme_adaptable', language 'fr', version '5.0'.
 *
...
$string['dimmedtextcolour'] = 'Couleur du texte atténuée';
$string['dimmedtextcolourdesc'] = 'La classe CSS de texte atténuée (dimmed_text) est utilisée par Moodle pour indiquer qu\'un élément est désactivé ou invisible. Pour définir cette couleur dans le thème, utilisez du code hexadécimal HTML.';
...
$string['enablesavecanceloverlayresetconfirm'] = 'Cette action réinitialise toutes les modifications apportées depuis le chargement de cette page. Voulez-vous vraiment continuer ?';
...
$string['enableuserfavmenu'] = 'Activer le menu des favoris de l\'utilisateur';
$string['enableuserfavmenudesc'] = 'Pour des raisons de performances, il est recommandé de laisser cette option désactivée si le menu n\'est pas utilisé.';
...
$string['fontcolour'] = 'Couleur de police principale';
$string['fontcolourdesc'] = 'Définir la couleur de la police dans le thème ; utiliser le code hexadécimal HTML.';
...
$string['fontsizedesc'] = 'Sélectionner la taille de police par défaut (en pourcentage) utilisée sur l’ensemble du site.';
...
$string['footerdividingline'] = 'Couleur de la ligne de séparation du pied de page';
...
$string['headerbreadcrumb'] = 'Fil d\'Ariane';
$string['headerbreadcrumbdesc'] = 'Personnalisations du fil d\'Ariane.';
...
$string['headernavbarcustommenuheading'] = 'Menu personnalisé';
...
$string['newstickersettings'] = 'Fil d\'informations';
...
$string['printbodyfontsize'] = 'Taille de la police du corps de texte';
...
$string['themereadme'] = 'Lisez moi';
$string['themesupportsponsorship'] = 'Support et partenariat';
$string['thiscourse'] = 'Cours actuel';
$string['ticker'] = 'Annonces';
$string['tickerconstainerbackgroundcolour'] = 'Couleur d\'arrière-plan du fil d\'informations';
$string['tickerconstainertextcolour'] = 'Couleur du texte du fil d\'informations';
$string['tickerdefault'] = 'Aucun nouvel élément à afficher';
$string['tickerdesc'] = 'Ici, vous pouvez définir un fil d\'informations sur la page d’accueil de votre site Moodle.
...
$string['tickerheaderbackgroundcolour'] = 'Couleur d\'arrière-plan de l\'en-tête du fil d\'informations';
$string['tickerheadertextcolour'] = 'Couleur du texte de l\'en-tête du fil d\'informations';
...
$string['tickertextdesc'] = 'Ajouter le texte du fil d\'informations en format liste. Voir le fichier Readme pour plus d’info.';
