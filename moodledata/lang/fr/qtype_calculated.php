...
/**
 * Strings for component 'qtype_calculated', language 'fr', version '5.0'.
 *
...
$string['forceregenerationall'] = 'Forcer la régénération de toutes variables';
$string['forceregenerationshared'] = 'Forcer la régénération des variables non partagées uniquement';
...
$string['reuseifpossible'] = 'Réutiliser les valeurs précédentes si possible';
$string['setno'] = 'Jeu {$a}';
