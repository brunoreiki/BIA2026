...
/**
 * Strings for component 'report_modulecompletion', language 'fr', version '5.0'.
 *
...
$string['metadata_list_label'] = 'Choisir les métadonnées';
...
$string['show_metadata_in_profile_description'] = 'Si vous avez coché « Utiliser le plugin metadata », les métadonnées seront affichées dans les rapports depuis l’administration. Ce paramètre vous permet d’afficher les métadonnées dans le profil utilisateur également.';
$string['show_metadata_in_profile_label'] = 'Afficher les métadonnées dans le profil utilisateur';
