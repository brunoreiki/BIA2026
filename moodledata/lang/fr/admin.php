...
/**
 * Strings for component 'admin', language 'fr', version '5.0'.
 *
 * @package     admin
 * @category    string
...
$string['deletedplugintypesdetected'] = 'Un plugin supprimé, « {$a} », a été détecté. Il aurait dû être déplacé/désinstallé lors de l’étape de dépréciation. Il s’agit désormais d’un plugin de type non pris en charge, et l’installation/la mise à jour ne pas continuer tant que le plugin n’est pas désinstalllé.';
...
$string['navfilter'] = 'Filtrer le menu personnalisé';
$string['navfilter_desc'] = 'Filtrer le menu personnalisé à l’aide des filtres Moodle qui sont appliqués au <strong>Contenu et titres</strong>. Utile pour faire des éléments du menu personnalisé dynamiques.';
