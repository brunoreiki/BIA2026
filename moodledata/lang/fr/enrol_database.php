...
/**
 * Strings for component 'enrol_database', language 'fr', version '5.0'.
 *
...
$string['dbsybasequoting_desc'] = 'Style Sybase pour l’échappement des apostrophes. Ce réglage est nécessaire pour les bases de données MS SQL et d’autres types de base de données. Ne pas utiliser avec MySQL !';
