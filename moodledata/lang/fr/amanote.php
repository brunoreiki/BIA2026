...
/**
 * Strings for component 'amanote', language 'fr', version '5.0'.
 *
 * @package     amanote
 * @category    string
...
$string['privacy:metadata:email'] = 'Le courriel de l’utilisateur est envoyé au système distant pour améliorer les retours d’expérience utilisateur (partage de notes, notification, etc.).';
