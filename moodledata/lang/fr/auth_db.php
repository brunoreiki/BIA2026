...
/**
 * Strings for component 'auth_db', language 'fr', version '5.0'.
 *
 * @package     auth_db
 * @category    string
...
$string['auth_dbsybasequotinghelp'] = 'Style Sybase pour l’échappement des apostrophes. Ce réglage est nécessaire pour les bases de données MS SQL et d’autres types. Ne pas utiliser avec MySQL !';
