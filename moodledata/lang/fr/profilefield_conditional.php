...
/**
 * Strings for component 'profilefield_conditional', language 'fr', version '5.0'.
 *
...
$string['privacy:metadata:profilefield_conditional:fieldid'] = 'L’identifiant du champ de profil';
$string['privacy:metadata:profilefield_conditional:tableexplanation'] = 'Données de profil complémentaires';
$string['privacy:metadata:profilefield_conditional:userid'] = 'L’identifiant de l’utilisateur dont les données sont stockées dans le champ du profil d’utilisateur conditionnel';
