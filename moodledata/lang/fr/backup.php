...
/**
 * Strings for component 'backup', language 'fr', version '5.0'.
 *
 * @package     backup
 * @category    string
...
$string['qcategory2coursefallback'] = 'La catégorie de questions « {$a->name} », située dans le contexte system|course|course_category dans le fichier de sauvegarde, sera créée dans un contexte du module banque de question lors de la restauration';
$string['qcategorycannotberestored'] = 'La catégorie de questions « {$a->name} » ne peut pas être créée durant la restauration';
$string['question2coursefallback'] = 'La catégorie de questions « {$a->name} », située dans le contexte system|course|course_category dans le fichier de sauvegarde, sera créée dans un contexte du module banque de question lors de la restauration';
