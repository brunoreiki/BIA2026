...
/**
 * Strings for component 'dynamo', language 'fr', version '5.0'.
 *
 * @package     dynamo
 * @category    string
...
$string['dynamo:build'] = 'Version de Dynamo';
...
$string['dynamoheadevalfirstname'] = 'Évaluateur prénom';
$string['dynamoheadevallastname'] = 'Évaluateur nom';
...
$string['dynamosendmail'] = 'Envoie de courriels';
