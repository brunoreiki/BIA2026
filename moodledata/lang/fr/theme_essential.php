...
/**
 * Strings for component 'theme_essential', language 'fr', version '5.0'.
 *
...
$string['alertsdesc'] = 'Ceci va afficher une (ou plusieurs) alerte(s) dans trois différents styles à vos utilisateurs sur la page d’accueil de Moodle. Pensez à les désactiver lorsqu’elles ne seront plus nécessaires.';
...
$string['alternativethemequizsubmitbackgroundcolour'] = 'Test : couleur de fond {$a} du bouton « Soumettre tout et terminer »';
...
$string['alternativethemequizsubmitbackgroundhovercolour'] = 'Test : couleur de survol {$a} de l’arrière-plan du bouton « Soumettre tout et terminer »';
...
$string['alternativethemequizsubmittextcolour'] = 'Test : couleur du texte {$a} du bouton « Soumettre tout et terminer ».';
...
$string['alternativethemequizsubmittexthovercolour'] = 'Test : couleur de survol {$a} du texte du bouton « Soumettre tout et terminer »';
...
$string['csd'] = 'Date de début du cours';
...
$string['logodimerror'] = 'est non valide. Veuillez indiquer "px" ou "em" immédiatement après l’unité et rien avant.';
...
$string['themequizsubmitbackgroundcolour'] = 'Test : couleur de fond de « Soumettre tout et terminer »';
$string['themequizsubmitbackgroundcolourdesc'] = 'Test : définir la couleur de fond pour le bouton « Soumettre tout et terminer ».';
$string['themequizsubmitbackgroundhovercolour'] = 'Test : couleur au survol de « Soumettre tout et terminer »';
$string['themequizsubmitbackgroundhovercolourdesc'] = 'Test : définissez la couleur de survol de l’arrière-plan pour le bouton « Soumettre tout et terminer ».';
$string['themequizsubmittextcolour'] = 'Test : couleur du texte « Soumettre tout et terminer »';
$string['themequizsubmittextcolourdesc'] = 'Définissez la couleur du texte pour le bouton \'Soumettre tout et terminer\'.';
$string['themequizsubmittexthovercolour'] = 'Test : couleur de survol du texte « Soumettre tout et terminer »';
