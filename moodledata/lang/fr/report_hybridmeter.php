...
/**
 * Strings for component 'report_hybridmeter', language 'fr', version '5.0'.
 *
...
$string['nb_analysed_courses'] = 'Cours analysés';
$string['nb_digitalised_courses'] = 'Cours hybrides selon l’indicateur du niveau de digitalisation';
$string['nb_students_concerned_digitalised'] = 'Étudiants inscrits dans au moins un cours hybride selon l’indicateur du niveau de digitalisation en date du';
$string['nb_students_concerned_digitalised_active'] = 'Étudiants actifs dans au moins un cours hybride selon l’indicateur du niveau de digitalisation';
$string['nb_students_concerned_used'] = 'Étudiants inscrits dans au moins un cours hybride selon l’indicateur du niveau d’utilisation en date du';
$string['nb_students_concerned_used_active'] = 'Étudiants actifs dans au moins un cours hybride selon l’indicateur du niveau d’utilisation';
$string['nb_used_courses'] = 'Cours hybrides selon l’indicateur du niveau d’utilisation';
...
$string['report/hybridmeter:all'] = 'Accès à HybridMeter';
