...
/**
 * Strings for component 'via', language 'fr', version '5.0'.
 *
 * @package     via
 * @category    string
...
$string['backup'] = 'Inclure les sondages dans la sauvegarde de cours';
...
$string['df_header_view'] = 'Action';
$string['df_header_visibility'] = 'Visibilité';
...
$string['duplication'] = 'Inclure les sondages dans la duplication';
...
$string['error:EMAIL_TOO_LONG'] = 'EMAIL_TOO_LONG - La valeur Courriel dépasse le maximum de 100 caractères.';
...
$string['error:INVALID_FRIDAY_VALUE'] = 'INVALID_FRIDAY_VALUE - La valeur de la propriété Friday est non valide.';
...
$string['error:INVALID_MONDAY_VALUE'] = 'INVALID_MONDAY_VALUE - La valeur de la propriété Monday est non valide.';
...
$string['error:INVALID_OBJECT_FORMAT'] = 'INVALID_OBJECT_FORMAT - Le INNERXML du soap:body est non valide.';
...
$string['error:INVALID_SATURDAY_VALUE'] = 'INVALID_SATURDAY_VALUE - La valeur de la propriété Saturday est non valide.';
...
$string['error:INVALID_SUNDAY_VALUE'] = 'INVALID_SUNDAY_VALUE - La valeur de la propriété Sunday est non valide.';
$string['error:INVALID_THURSDAY_VALUE'] = 'INVALID_THURSDAY_VALUE - La valeur de la propriété Thursday est non valide.';
...
$string['error:INVALID_TUESDAY_VALUE'] = 'INVALID_TUESDAY_VALUE - La valeur de la propriété Tuesday est non valide.';
...
$string['error:INVALID_WEDNESDAY_VALUE'] = 'INVALID_WEDNESDAY_VALUE - La valeur de la propriété Wednesday est non valide.';
...
$string['noparticipantscheckbox'] = 'Ajouter tous les étudiants comme animateurs';
...
$string['notifysuccess_synch2'] = 'Certains utilisateurs ne peuvent pas être synchronisés, veuillez valider leurs informations et essayer à nouveau.';
...
$string['pluginname'] = 'Via - Classe virtuelle';
...
$string['resource_formative_quiz'] = 'Quiz formatif';
$string['resource_image'] = 'Image';
$string['resource_quiz'] = 'Quiz';
$string['resource_survey'] = 'Sondage';
$string['resource_url'] = 'URL';
$string['resource_visibility_0'] = 'Administrateurs';
$string['resource_visibility_1'] = 'Tous les participants';
$string['resource_whiteboard'] = 'Tableau blanc';
$string['resources'] = 'Ressources';
$string['resources_access_result'] = 'Voir les résultats';
$string['resources_confirmdelete'] = 'Voulez-vous vraiment retirer la ressource « {$a} » ?';
$string['resources_delete_success'] = 'La ressource « {$a} » a été retirée avec succès';
$string['resources_document_warning'] = 'Attention ! Retirer cette ressource alors qu’elle contient des notes supprimera également les notes.';
$string['resources_downloadable'] = 'Rendre téléchargeable';
$string['resources_downloadable_subroom'] = 'Rendre téléchargeable dans l’activité';
$string['resources_edit'] = 'Éditer la ressource';
$string['resources_edit_success'] = 'La ressource "{$a}" a été éditée correctement';
$string['resources_mainroom'] = 'Salle principale';
$string['resources_remove'] = 'Retirer la ressource';
$string['resources_settings'] = 'Paramètres';
$string['resources_survey_visibility_warning'] = 'Activer cette option afin que les participants ne puissent voir que leurs résultats. Les administrateurs ont toujours accès à l’intégralité des résultats des quiz et des sondages.';
$string['resources_survey_warning'] = 'Attention ! Retirer cette ressource supprimera également tous les résultats des devoirs dans cette activité.';
$string['resources_visibility'] = 'Visibilité de la ressource';
$string['resources_visibility_edit'] = 'Paramétrer la visibilité';
$string['resources_visibility_public'] = 'Rendre la ressource visible à tous les participants';
...
$string['roomversion'] = 'Choisir la version de Via pour cette activité';
